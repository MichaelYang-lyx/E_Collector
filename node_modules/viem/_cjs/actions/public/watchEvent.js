    ...
    const pollEvent = () => {
        ...
        return (0, observe_js_1.observe)(observerId, { onLogs, onError }, (emit) => {
            ...
            const unwatch = (0, poll_js_1.poll)(async () => {
                if (!initialized) {
                    try {
                        filter = (await (0, getAction_js_1.getAction)(client, createEventFilter_js_1.createEventFilter)({
                            address,
                            args,
                            event: event,
                            events,
                ...
                try {
                    ...
                    if (filter) {
                        ...
                        if (previousBlockNumber && previousBlockNumber !== blockNumber) {
                            logs = await (0, getAction_js_1.getAction)(client, getLogs_js_1.getLogs)({
                                address,
                                args,
                                event: event,
                                events,
