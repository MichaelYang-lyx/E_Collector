            ...
            contract.read = new Proxy({}, {
                get(_, functionName) {
                    return (...parameters) => {
                        ...
                        return (0, getAction_js_1.getAction)(publicClient, readContract_js_1.readContract)({
                            abi,
                            address,
                            functionName,
                            args,
        ...
        if (hasWriteFunction)
            contract.simulate = new Proxy({}, {
                get(_, functionName) {
                    return (...parameters) => {
                        const { args, options } = getFunctionParameters(parameters);
                        return (0, getAction_js_1.getAction)(publicClient, simulateContract_js_1.simulateContract)({
                            abi,
                            address,
                            functionName,
                            args,
            ...
            contract.createEventFilter = new Proxy({}, {
                get(_, eventName) {
                    return (...parameters) => {
                        ...
                        return (0, getAction_js_1.getAction)(publicClient, createContractEventFilter_js_1.createContractEventFilter)({
                            abi,
                            address,
                            eventName,
                            args,
            ...
            contract.getEvents = new Proxy({}, {
                get(_, eventName) {
                    return (...parameters) => {
                        const abiEvent = abi.find((x) => x.type === 'event' && x.name === eventName);
                        const { args, options } = getEventParameters(parameters, abiEvent);
                        return (0, getAction_js_1.getAction)(publicClient, getContractEvents_js_1.getContractEvents)({
                            abi,
                            address,
                            eventName,
                            args,
            ...
            contract.watchEvent = new Proxy({}, {
                get(_, eventName) {
                    return (...parameters) => {
                        const abiEvent = abi.find((x) => x.type === 'event' && x.name === eventName);
                        const { args, options } = getEventParameters(parameters, abiEvent);
                        return (0, getAction_js_1.getAction)(publicClient, watchContractEvent_js_1.watchContractEvent)({
                            abi,
                            address,
                            eventName,
                            args,
        ...
        if (hasWriteFunction)
            contract.write = new Proxy({}, {
                get(_, functionName) {
                    return (...parameters) => {
                        const { args, options } = getFunctionParameters(parameters);
                        return (0, getAction_js_1.getAction)(walletClient, writeContract_js_1.writeContract)({
                            abi,
                            address,
                            functionName,
                            args,
            ...
            contract.estimateGas = new Proxy({}, {
                get(_, functionName) {
                    return (...parameters) => {
                        ...
                        return (0, getAction_js_1.getAction)(client, estimateContractGas_js_1.estimateContractGas)({
                            abi,
                            address,
                            functionName,
                            args,
