...
export type WalletActions<TChain extends Chain | undefined = Chain | undefined, TAccount extends Account | undefined = Account | undefined> = {
     ...
     * })
     */
    prepareTransactionRequest: <TChainOverride extends Chain | undefined = undefined>(args: PrepareTransactionRequestParameters<TChain, TAccount, TChainOverride>) => Promise<PrepareTransactionRequestReturnType>;
    /**
     ...
     * const signature = await client.signTransaction(request)
     */
    signTransaction: <TChainOverride extends Chain | undefined = undefined>(args: SignTransactionParameters<TChain, TAccount, TChainOverride>) => Promise<SignTransactionReturnType>;
    /**
