...
export type RpcTransaction<TPending extends boolean = boolean> = UnionOmit<TransactionLegacy<Quantity, Index, TPending, '0x0'> | TransactionEIP2930<Quantity, Index, TPending, '0x1'> | TransactionEIP1559<Quantity, Index, TPending, '0x2'>, 'typeHex'>;
