...
import type { OptimismRpcBlockOverrides, OptimismRpcTransaction, OptimismRpcTransactionReceiptOverrides, OptimismTransaction } from './types.js';
export declare const formattersOptimism: {
    readonly block: {
        exclude: [] | undefined;
        format: (args: import("../../types/utils.js").Assign<Partial<import("../../types/rpc.js").RpcBlock>, OptimismRpcBlockOverrides & {
    ...
    readonly transactionReceipt: {
        exclude: [] | undefined;
        format: (args: import("../../types/utils.js").Assign<Partial<import("../../types/rpc.js").RpcTransactionReceipt>, OptimismRpcTransactionReceiptOverrides>) => {
            blockHash: `0x${string}`;
            blockNumber: bigint;
