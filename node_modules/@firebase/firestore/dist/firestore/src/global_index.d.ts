 ...
 * limitations under the License.
 */
declare type FirebaseSignInProvider = 'custom' | 'email' | 'password' | 'phone' | 'anonymous' | 'google.com' | 'facebook.com' | 'github.com' | 'twitter.com' | 'microsoft.com' | 'apple.com';
 ...
 */
declare type TaskState = 'Error' | 'Running' | 'Success';
/**
...
declare abstract class Filter {
    ...
    abstract getFirstInequalityField(): FieldPath$1 | null;
}
declare class FieldFilter extends Filter {
    ...
    getFilters(): Filter[];
    getFirstInequalityField(): FieldPath$1 | null;
}
...
declare type DocumentMap = SortedMap<DocumentKey, Document>;
...
/** LimitType enum. */
declare type LimitType = 'FIRST' | 'LAST';
 ...
 * @internal
 */
declare type AggregateType = 'count' | 'avg' | 'sum';
...
declare type DocumentComparator = (doc1: Document, doc2: Document) => number;
 ...
 */
declare type MemoryGarbageCollector = MemoryEagerGarbageCollector | MemoryLruGarbageCollector;
/**
 ...
 */
declare type MemoryEagerGarbageCollector = {
    kind: 'memoryEager';
    /**
     * @internal
     */
 ...
 * instance of this collector.
 */
declare type MemoryLruGarbageCollector = {
    kind: 'memoryLru';
    /**
     * @internal
     */
 ...
 */
declare type MemoryCacheSettings = {
    /**
 ...
 */
declare type PersistentCacheSettings = {
    /**
 ...
 */
declare type PersistentSingleTabManager = {
 ...
 */
declare type PersistentMultipleTabManager = {
 ...
 */
declare type PersistentTabManager = PersistentSingleTabManager | PersistentMultipleTabManager;
/**
 * Type to configure an `PersistentSingleTabManager` instance.
 */
declare type PersistentSingleTabManagerSettings = {
    /**
 ...
 */
declare type NestedUpdateFields<T extends Record<string, unknown>> = UnionToIntersection<{
 ...
 */
declare type ChildUpdateFields<K extends string, V> = V extends Record<string, unknown> ? AddPrefixToKeys<K, UpdateData<V>> : never;
/**
 ...
 */
declare type PartialWithFieldValue<T> = Partial<T> | (T extends Primitive ? T : T extends {} ? {
 ...
 * type safety.
 */
declare type WithFieldValue<T> = T | (T extends Primitive ? T : T extends {} ? {
 ...
 * as property values.
 */
declare type UpdateData<T> = T extends Primitive ? T : T extends {} ? {
...
declare class Query<AppModelType = DocumentData, DbModelType extends DocumentData = DocumentData> {
     ...
     */
    withConverter<NewAppModelType, NewDbModelType extends DocumentData>(converter: FirestoreDataConverter$1<NewAppModelType, NewDbModelType>): Query<NewAppModelType, NewDbModelType>;
}
/**
...
declare class DocumentReference<AppModelType = DocumentData, DbModelType extends DocumentData = DocumentData> {
     ...
     */
    withConverter<NewAppModelType, NewDbModelType extends DocumentData>(converter: FirestoreDataConverter$1<NewAppModelType, NewDbModelType>): DocumentReference<NewAppModelType, NewDbModelType>;
    /**
     * Removes the current converter.
     *
     * @param converter - `null` removes the current converter.
...
declare class CollectionReference<AppModelType = DocumentData, DbModelType extends DocumentData = DocumentData> extends Query<AppModelType, DbModelType> {
     ...
     */
    withConverter<NewAppModelType, NewDbModelType extends DocumentData>(converter: FirestoreDataConverter$1<NewAppModelType, NewDbModelType>): CollectionReference<NewAppModelType, NewDbModelType>;
    /**
     * Removes the current converter.
     *
     * @param converter - `null` removes the current converter.
...
declare class AggregateField<T> {
    readonly _aggregateType: AggregateType;
     ...
     * @internal
     */
    constructor(_aggregateType?: AggregateType, _internalFieldPath?: FieldPath$1 | undefined);
}
/**
 * The union of all `AggregateField` types that are supported by Firestore.
 */
declare type AggregateFieldType = AggregateField<number | null>;
/**
 ...
 */
declare type AggregateSpecData<T extends AggregateSpec> = {
 ...
 */
declare type DocumentChangeType = 'added' | 'removed' | 'modified';
/**
...
declare type QueryConstraintType = 'where' | 'orderBy' | 'limit' | 'limitToLast' | 'startAt' | 'startAfter' | 'endAt' | 'endBefore';
/**
 ...
 */
declare type QueryNonFilterConstraint = QueryOrderByConstraint | QueryLimitConstraint | QueryStartAtConstraint | QueryEndAtConstraint;
/**
 * `QueryFilterConstraint` is a helper union type that represents
 * {@link QueryFieldFilterConstraint} and {@link QueryCompositeFilterConstraint}.
 */
declare type QueryFilterConstraint = QueryFieldFilterConstraint | QueryCompositeFilterConstraint;
/**
 ...
 * @internal
 */
declare type ExistenceFilterMismatchCallback = (info: ExistenceFilterMismatchInfo) => unknown;
