...
declare const MetaMaskButton: ({ color, theme, shape, icon, iconPosition, text, textAlign, buttonStyle, textStyle, iconStyle, removeDefaultStyles, connectComponent, wrongNetworkComponent, wrongNetworkText, connectedComponent, }: Props) => JSX.Element | null;
