...
var __PRIVATE_QueryImpl = class {
  ...
  constructor(e, t = null, n = [], r2 = [], i = null, s = "F", o = null, _ = null) {
    this.path = e, this.collectionGroup = t, this.explicitOrderBy = n, this.filters = r2, this.limit = i, this.limitType = s, this.startAt = o, this.endAt = _, this.Pe = null, // The corresponding `Target` of this `Query` instance, for use with
...
var BloomFilter = class _BloomFilter {
  constructor(e, t, n) {
    ...
    this.Ae = 8 * e.length - t, // Set the bit count in Integer to avoid repetition in mightContain().
    this.Re = Integer.fromNumber(this.Ae);
  }
  // Calculate the ith hash value based on the hashed 64bit integers,
  // and calculate its corresponding bit index in the bitmap to be checked.
  Ve(e, t, n) {
    let r2 = e.add(t.multiply(Integer.fromNumber(n)));
    return 1 === r2.compare(le) && (r2 = new Integer([r2.getBits(0), r2.getBits(1)], 0)), r2.modulo(this.Re).toNumber();
  }
...
var __PRIVATE_TargetState = class {
  constructor() {
     ...
     */
    this.Se = __PRIVATE_snapshotChangesMap(), /** See public getters for explanations of these fields. */
    this.be = ByteString.EMPTY_BYTE_STRING, this.De = false, /**
   ...
   */
  Me(e) {
    e.approximateByteSize() > 0 && (this.Ce = true, this.be = e);
  }
  /**
   ...
   */
  Oe() {
    this.Ce = false, this.Se = __PRIVATE_snapshotChangesMap();
  }
  Ne(e, t) {
    this.Ce = true, this.Se = this.Se.insert(e, t);
  }
  Be(e) {
    this.Ce = true, this.Se = this.Se.remove(e);
  }
  Le() {
    this.we += 1;
  }
...
var __PRIVATE_WatchChangeAggregator = class {
  constructor(e) {
    ...
    this.$e = __PRIVATE_mutableDocumentMap(), /** A mapping of document keys to their set of target IDs. */
    ...
    this.forEachTarget(e, (t) => {
      ...
      switch (e.state) {
        ...
        case 1:
          ...
          break;
        case 2:
          n.ke(), n.ve || this.removeTarget(t);
          break;
        case 3:
          this.Ye(t) && (n.qe(), n.Me(e.resumeToken));
          break;
        case 4:
          this.Ye(t) && // Reset the target and synthesizes removes for all existing
   ...
   */
  Xe(e) {
    const t = e.targetId, n = e.ye.count, r2 = this.et(t);
    if (r2) {
      const i = r2.target;
      if (__PRIVATE_targetIsDocumentTarget(i))
        if (0 === n) {
          const e2 = new DocumentKey(i.path);
          this.je(t, e2, MutableDocument.newNoDocument(e2, SnapshotVersion.min()));
        } else
          __PRIVATE_hardAssert(1 === n);
      else {
        const r3 = this.tt(t);
        if (r3 !== n) {
          const n2 = this.nt(e), i2 = n2 ? this.rt(n2, e, r3) : 1;
          if (0 !== i2) {
            this.Ze(t);
            const e2 = 2 === i2 ? "TargetPurposeExistenceFilterMismatchBloom" : "TargetPurposeExistenceFilterMismatch";
            this.We = this.We.insert(t, e2);
          }
          null == ce || ce.it(function __PRIVATE_createExistenceFilterMismatchInfoForTestingHooks(e2, t2, n3, r4, i3) {
            var s, o, _, a, u, c;
            const l2 = {
              localCacheCount: e2,
   ...
   */
  rt(e, t, n) {
    return t.ye.count === n - this.ot(e, t.targetId) ? 0 : 2;
  }
  /**
  ...
  ot(e, t) {
    ...
    let r2 = 0;
    return n.forEach((n2) => {
      const i = this.Qe.st(), s = `projects/${i.projectId}/databases/${i.database}/documents/${n2.path.canonicalString()}`;
      e.mightContain(s) || (this.je(
        t,
        n2,
        /*updatedDocument=*/
        null
    ...
    this.Ke.forEach((n2, r3) => {
      ...
      if (i) {
        if (n2.current && __PRIVATE_targetIsDocumentTarget(i.target)) {
          ...
          null !== this.$e.get(t2) || this.ut(r3, t2) || this.je(r3, t2, MutableDocument.newNoDocument(t2, e));
        }
  ...
  ze(e, t) {
    ...
    this.Je(e).Ne(t.key, n), this.$e = this.$e.insert(t.key, t), this.Ue = this.Ue.insert(t.key, this.ct(t.key).add(e));
  }
  /**
  ...
  je(e, t, n) {
    ...
    this.ut(e, t) ? r2.Ne(
      ...
      r2.Be(t)
    ), this.Ue = this.Ue.insert(t, this.ct(t).delete(e)), n && (this.$e = this.$e.insert(t, n));
  }
  removeTarget(e) {
    this.Ke.delete(e);
  }
  ...
  et(e) {
    ...
    return t && t.ve ? null : this.Qe.lt(e);
  }
  /**
...
function __PRIVATE_fromDbRemoteDocument(e, t) {
  let n;
  if (t.document)
    n = __PRIVATE_fromDocument(e.ht, t.document, !!t.hasCommittedMutations);
...
function __PRIVATE_fromDbMutationBatch(e, t) {
  const n = (t.baseMutations || []).map((t2) => __PRIVATE_fromMutation(e.ht, t2));
  ...
  const r2 = t.mutations.map((t2) => __PRIVATE_fromMutation(e.ht, t2)), i = Timestamp.fromMillis(t.localWriteTimeMs);
...
function __PRIVATE_toDbTarget(e, t) {
  ...
  let i;
  i = __PRIVATE_targetIsDocumentTarget(t.target) ? __PRIVATE_toDocumentsTarget(e.ht, t.target) : __PRIVATE_toQueryTarget(e.ht, t.target);
...
function __PRIVATE_fromDbDocumentOverlay(e, t) {
  return new Overlay(t.largestBatchId, __PRIVATE_fromMutation(e.ht, t.overlayMutation));
}
  ...
  It(e, t) {
    return __PRIVATE_documentOverlayStore(e).put(function __PRIVATE_toDbDocumentOverlay(e2, t2, n) {
      ...
      return {
        ...
        overlayMutation: toMutation(e2.ht, n.mutation)
      };
...
var __PRIVATE_FirestoreIndexValueWriter = class {
  ...
  Tt(e, t) {
    if ("nullValue" in e)
      ...
      this.At(t, 10), t.Rt(e.booleanValue ? 1 : 0);
    else if ("integerValue" in e)
      this.At(t, 15), t.Rt(__PRIVATE_normalizeNumber(e.integerValue));
    else if ("doubleValue" in e) {
      const n = __PRIVATE_normalizeNumber(e.doubleValue);
      isNaN(n) ? this.At(t, 13) : (this.At(t, 15), __PRIVATE_isNegativeZero(n) ? (
        // -0.0, 0 and 0.0 are all considered the same
        t.Rt(0)
      ) : t.Rt(n));
    } else if ("timestampValue" in e) {
      const n = e.timestampValue;
      this.At(t, 20), "string" == typeof n ? t.Vt(n) : (t.Vt(`${n.seconds || ""}`), t.Rt(n.nanos || 0));
    } else if ("stringValue" in e)
      this.ft(e.stringValue, t), this.gt(t);
    else if ("bytesValue" in e)
      this.At(t, 30), t.yt(__PRIVATE_normalizeByteString(e.bytesValue)), this.gt(t);
    else if ("referenceValue" in e)
      this.wt(e.referenceValue, t);
    else if ("geoPointValue" in e) {
      const n = e.geoPointValue;
      this.At(t, 45), t.Rt(n.latitude || 0), t.Rt(n.longitude || 0);
    } else
      "mapValue" in e ? __PRIVATE_isMaxValue(e) ? this.At(t, Number.MAX_SAFE_INTEGER) : (this.St(e.mapValue, t), this.gt(t)) : "arrayValue" in e ? (this.bt(e.arrayValue, t), this.gt(t)) : fail();
  }
  ft(e, t) {
    this.At(t, 25), this.Dt(e, t);
  }
  Dt(e, t) {
    t.Vt(e);
  }
...
__PRIVATE_FirestoreIndexValueWriter.Ct = new __PRIVATE_FirestoreIndexValueWriter();
...
var __PRIVATE_TargetIndexMatcher = class {
  constructor(e) {
    this.collectionId = null != e.collectionGroup ? e.collectionGroup : e.path.lastSegment(), this.Xt = e.orderBy, this.en = [];
    for (const t of e.filters) {
      const e2 = t;
      e2.isInequality() ? this.tn = e2 : this.en.push(e2);
    }
  }
  /**
  ...
  nn(e) {
    ...
    if (void 0 !== t && !this.rn(t))
      return false;
    const n = __PRIVATE_fieldIndexGetDirectionalSegments(e);
    let r2 = /* @__PURE__ */ new Set(), i = 0, s = 0;
    for (; i < n.length && this.rn(n[i]); ++i)
      r2 = r2.add(n[i].fieldPath.canonicalString());
    if (i === n.length)
      return true;
    if (void 0 !== this.tn) {
      if (!r2.has(this.tn.field.canonicalString())) {
        const e2 = n[i];
        if (!this.sn(this.tn, e2) || !this.on(this.Xt[s++], e2))
          return false;
      }
      ++i;
    }
    for (; i < n.length; ++i) {
      const e2 = n[i];
      if (s >= this.Xt.length || !this.on(this.Xt[s++], e2))
        return false;
    }
    return true;
  }
...
var __PRIVATE_IndexedDbIndexManager = class {
  ...
  createTargetIndexes(e, t) {
    return PersistencePromise.forEach(this.ln(t), (t2) => this.getIndexType(e, t2).next((n) => {
      if (0 === n || 1 === n) {
        const n2 = new __PRIVATE_TargetIndexMatcher(t2);
        return this.addFieldIndex(e, n2._n());
      }
    }));
  }
  getDocumentsMatchingTarget(e, t) {
      ...
      if (r2) {
        ...
        return PersistencePromise.forEach(i, (i2, s) => {
          ...
          const o = function __PRIVATE_targetGetArrayValues(e3, t2) {
            ...
            return new Bound(n2, r4);
          }(s, i2), c = this.Pn(i2, s, a), l2 = this.Pn(i2, s, u), h = this.In(i2, s, _), P2 = this.dn(i2.indexId, o, c, a.inclusive, l2, u.inclusive, h);
  ...
  dn(e, t, n, r2, i, s, o) {
    ...
    for (let c = 0; c < _; ++c) {
      const _2 = t ? this.Tn(t[c / a]) : de, l2 = this.En(e, _2, n[c % a], r2), h = this.An(e, _2, i[c % a], s), P2 = o.map((t2) => this.En(
        e,
        _2,
        t2,
        /* inclusive= */
  ...
  hn(e, t) {
    ...
    return this.getFieldIndexes(e, r2).next((e2) => {
      let t2 = null;
      for (const r3 of e2) {
        n.nn(r3) && (!t2 || r3.fields.length > t2.fields.length) && (t2 = r3);
      }
      return t2;
    });
  }
  getIndexType(e, t) {
    let n = 2;
    const r2 = this.ln(t);
    return PersistencePromise.forEach(r2, (t2) => this.hn(e, t2).next((e2) => {
  ...
  Rn(e, t) {
    ...
    for (const r2 of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      ...
      if (null == e2)
        return null;
      const i = n.Yt(r2.kind);
      __PRIVATE_FirestoreIndexValueWriter.Ct.dt(e2, i);
    }
    return n.zt();
  }
  ...
  Tn(e) {
    ...
    return __PRIVATE_FirestoreIndexValueWriter.Ct.dt(e, t.Yt(
      0
      /* IndexKind.ASCENDING */
    )), t.zt();
  }
  ...
  Vn(e, t) {
    const n = new __PRIVATE_IndexByteEncoder();
    return __PRIVATE_FirestoreIndexValueWriter.Ct.dt(__PRIVATE_refValue(this.databaseId, t), n.Yt(function __PRIVATE_fieldIndexGetKeyOrder(e2) {
  ...
  In(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r2)
        if (this.mn(t, s.fieldPath) && isArray(e2))
          r2 = this.fn(r2, s, e2);
        else {
          const t2 = n2.Yt(s.kind);
          __PRIVATE_FirestoreIndexValueWriter.Ct.dt(e2, t2);
        }
    }
    return this.gn(r2);
  }
  ...
  fn(e, t, n) {
    ...
    for (const e2 of n.arrayValue.values || [])
      for (const n2 of r2) {
        ...
        r3.seed(n2.zt()), __PRIVATE_FirestoreIndexValueWriter.Ct.dt(e2, r3.Yt(t.kind)), i.push(r3);
      }
    return i;
  }
  mn(e, t) {
  ...
  updateCollectionGroup(e, t, n) {
    ...
    return this.pn(e).next((e2) => r2.G("collectionGroupIndex", IDBKeyRange.bound(t, t)).next((t2) => PersistencePromise.forEach(t2, (t3) => i.put(__PRIVATE_toDbIndexState(t3.indexId, this.user, e2, n)))));
  }
  updateIndexEntries(e, t) {
    ...
    return PersistencePromise.forEach(t, (t2, r2) => {
      ...
      return (i ? PersistencePromise.resolve(i) : this.getFieldIndexes(e, t2.collectionGroup)).next((i2) => (n.set(t2.collectionGroup, i2), PersistencePromise.forEach(i2, (n2) => this.yn(e, t2, n2).next((t3) => {
        const i3 = this.wn(r2, n2);
        return t3.isEqual(i3) ? PersistencePromise.resolve() : this.Sn(e, r2, n2, t3, i3);
      }))));
    });
  }
  bn(e, t, n, r2) {
  ...
  Dn(e, t, n, r2) {
    return __PRIVATE_indexEntriesStore(e).delete([r2.indexId, this.uid, r2.arrayValue, r2.directionalValue, this.Vn(n, t.key), t.key.path.toArray()]);
  }
  yn(e, t, n) {
...
var __PRIVATE_IndexedDbMutationQueue = class ___PRIVATE_IndexedDbMutationQueue {
  ...
  addMutationBatch(e, t, n, r2) {
    ...
    return s.add({}).next((o) => {
      ...
      const _ = new MutationBatch(o, t, n, r2), a = function __PRIVATE_toDbMutationBatch(e2, t2, n2) {
        const r3 = n2.baseMutations.map((t3) => toMutation(e2.ht, t3)), i2 = n2.mutations.map((t3) => toMutation(e2.ht, t3));
        return {
          userId: t2,
          batchId: n2.batchId,
  ...
  getAllMutationBatchesAffectingDocumentKeys(e, t) {
    ...
    return t.forEach((t2) => {
      ...
      r2.push(o);
    }), PersistencePromise.waitFor(r2).next(() => this.Mn(e, n));
  }
...
var __PRIVATE_IndexedDbTargetCache = class {
  ...
  setTargetsMetadata(e, t, n) {
    return this.kn(e).next((r2) => (r2.highestListenSequenceNumber = t, n && (r2.lastRemoteSnapshotVersion = n.toTimestamp()), t > r2.highestListenSequenceNumber && (r2.highestListenSequenceNumber = t), this.qn(e, r2)));
  }
  addTargetData(e, t) {
...
var __PRIVATE_LruScheduler = class {
  ...
  jn(e) {
    __PRIVATE_logDebug("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.zn = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", e, async () => {
      this.zn = null;
      try {
...
var __PRIVATE_LruGarbageCollectorImpl = class {
  ...
  collect(e, t) {
    return -1 === this.params.cacheSizeCollectionThreshold ? (__PRIVATE_logDebug("LruGarbageCollector", "Garbage collection skipped; disabled"), PersistencePromise.resolve(Te)) : this.getCacheSize(e).next((n) => n < this.params.cacheSizeCollectionThreshold ? (__PRIVATE_logDebug("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), Te) : this.Zn(e, t));
  }
  getCacheSize(e) {
...
var __PRIVATE_IndexedDbRemoteDocumentChangeBuffer = class extends RemoteDocumentChangeBuffer {
  ...
  getAllFromCache(e, t) {
    return this.ur._r(e, t).next(({ documents: e2, ar: t2 }) => (
...
var __PRIVATE_MemoryDocumentOverlayCache = class {
  ...
  removeOverlaysForBatchId(e, t, n) {
    const r2 = this.Pr.get(n);
    return void 0 !== r2 && (r2.forEach((e2) => this.overlays = this.overlays.remove(e2)), this.Pr.delete(n)), PersistencePromise.resolve();
  }
  getOverlaysForCollection(e, t, n) {
  ...
  It(e, t, n) {
    ...
    if (null !== r2) {
      const e2 = this.Pr.get(r2.largestBatchId).delete(n.key);
      this.Pr.set(r2.largestBatchId, e2);
    }
...
var __PRIVATE_ReferenceSet = class {
  constructor() {
    this.Ir = new SortedSet(__PRIVATE_DocReference.dr), // A set of outstanding references to a document sorted by target id.
  ...
  Rr(e) {
    this.Ir = this.Ir.delete(e), this.Tr = this.Tr.delete(e);
  }
  pr(e) {
...
var __PRIVATE_MemoryMutationQueue = class {
  ...
  addMutationBatch(e, t, n, r2) {
    ...
    for (const t2 of r2)
      this.Sr = this.Sr.add(new __PRIVATE_DocReference(t2.key, i)), this.indexManager.addToCollectionParentIndex(e, t2.key.path.popLast());
  ...
  getNextMutationBatchAfterBatchId(e, t) {
    const n = t + 1, r2 = this.Dr(n), i = r2 < 0 ? 0 : r2;
  ...
  getAllMutationBatchesAffectingDocumentKey(e, t) {
    ...
    return this.Sr.forEachInRange([n, r2], (e2) => {
  ...
  getAllMutationBatchesAffectingDocumentKeys(e, t) {
    ...
    return t.forEach((e2) => {
      ...
      this.Sr.forEachInRange([t2, r2], (e3) => {
        n = n.add(e3.yr);
      });
  ...
  containsKey(e, t) {
    const n = new __PRIVATE_DocReference(t, 0), r2 = this.Sr.firstAfterOrEqual(n);
...
var __PRIVATE_MemoryRemoteDocumentCacheImpl = class {
   ...
   */
  addEntry(e, t) {
    const n = t.key, r2 = this.docs.get(n), i = r2 ? r2.size : 0, s = this.Fr(t);
...
var __PRIVATE_MemoryRemoteDocumentChangeBuffer = class extends RemoteDocumentChangeBuffer {
  ...
  applyChanges(e) {
    ...
    return this.changes.forEach((n, r2) => {
      r2.isValidDocument() ? t.push(this.ur.addEntry(e, r2)) : this.ur.removeEntry(n);
...
var __PRIVATE_MemoryTargetCache = class {
  constructor(e) {
     ...
     * IDs.
     */
    this.Br = new __PRIVATE_ReferenceSet(), this.targetCount = 0, this.Lr = __PRIVATE_TargetIdGenerator.Bn();
  }
  forEachTarget(e, t) {
  ...
  Qn(e) {
    ...
    const t = e.targetId;
    t > this.highestTargetId && (this.Lr = new __PRIVATE_TargetIdGenerator(t), this.highestTargetId = t), e.sequenceNumber > this.Nr && (this.Nr = e.sequenceNumber);
  }
  addTargetData(e, t) {
  ...
  removeTargetData(e, t) {
    return this.Or.delete(t.target), this.Br.mr(t.targetId), this.targetCount -= 1, PersistencePromise.resolve();
  }
  removeTargets(e, t, n) {
    let r2 = 0;
    const i = [];
    return this.Or.forEach((s, o) => {
      o.sequenceNumber <= t && null === n.get(o.targetId) && (this.Or.delete(s), i.push(this.removeMatchingKeysForTargetId(e, o.targetId)), r2++);
  ...
  addMatchingKeys(e, t, n) {
    return this.Br.Ar(t, n), PersistencePromise.resolve();
  }
  removeMatchingKeys(e, t, n) {
    this.Br.Vr(t, n);
  ...
  removeMatchingKeysForTargetId(e, t) {
    return this.Br.mr(t), PersistencePromise.resolve();
  }
  getMatchingKeysForTargetId(e, t) {
    const n = this.Br.pr(t);
    return PersistencePromise.resolve(n);
  }
  containsKey(e, t) {
...
var __PRIVATE_MemoryPersistence = class {
   ...
   */
  constructor(e, t) {
    this.kr = {}, this.overlays = {}, this.qr = new __PRIVATE_ListenSequence(0), this.Qr = false, this.Qr = true, this.referenceDelegate = e(this), this.Kr = new __PRIVATE_MemoryTargetCache(this);
    ...
    }((e2) => this.referenceDelegate.$r(e2)), this.serializer = new __PRIVATE_LocalSerializer(t), this.Ur = new __PRIVATE_MemoryBundleCache(this.serializer);
  }
  start() {
  ...
  runTransaction(e, t, n) {
    ...
    return this.referenceDelegate.Wr(), n(r2).next((e2) => this.referenceDelegate.Gr(r2).next(() => e2)).toPromise().then((e2) => (r2.raiseOnCommittedEvent(), e2));
  }
  zr(e, t) {
...
var __PRIVATE_MemoryEagerDelegate = class ___PRIVATE_MemoryEagerDelegate {
  ...
  addReference(e, t, n) {
    return this.jr.addReference(n, t), this.Yr.delete(n.toString()), PersistencePromise.resolve();
  }
  removeReference(e, t, n) {
    return this.jr.removeReference(n, t), this.Yr.add(n.toString()), PersistencePromise.resolve();
  }
  markPotentiallyOrphaned(e, t) {
    return this.Yr.add(t.toString()), PersistencePromise.resolve();
  }
  removeTarget(e, t) {
    this.jr.mr(t.targetId).forEach((e2) => this.Yr.add(e2.toString()));
    const n = this.persistence.getTargetCache();
    return n.getMatchingKeysForTargetId(e, t.targetId).next((e2) => {
      e2.forEach((e3) => this.Yr.add(e3.toString()));
  ...
  Gr(e) {
    ...
    return PersistencePromise.forEach(this.Yr, (n) => {
      const r2 = DocumentKey.fromPath(n);
      return this.Zr(e, r2).next((e2) => {
        e2 || t.removeEntry(r2, SnapshotVersion.min());
      });
    }).next(() => (this.Hr = null, t.apply(e)));
  }
  updateLimboDocument(e, t) {
    return this.Zr(e, t).next((e2) => {
      e2 ? this.Yr.delete(t.toString()) : this.Yr.add(t.toString());
    });
  }
  $r(e) {
    return 0;
  ...
  Zr(e, t) {
    return PersistencePromise.or([() => PersistencePromise.resolve(this.jr.containsKey(t)), () => this.persistence.getTargetCache().containsKey(e, t), () => this.persistence.zr(e, t)]);
  }
};
var __PRIVATE_MemoryLruDelegate = class ___PRIVATE_MemoryLruDelegate {
  constructor(e, t) {
    this.persistence = e, this.Xr = new ObjectMap((e2) => __PRIVATE_encodeResourcePath(e2.path), (e2, t2) => e2.isEqual(t2)), this.garbageCollector = __PRIVATE_newLruGarbageCollector(this, t);
  }
  static Jr(e, t) {
  ...
  Yn(e, t) {
    return PersistencePromise.forEach(this.Xr, (n, r2) => this.tr(e, n, r2).next((e2) => e2 ? PersistencePromise.resolve() : t(r2)));
  }
  removeTargets(e, t, n) {
  ...
  removeOrphanedDocuments(e, t) {
    ...
    return r2.Mr(e, (r3) => this.tr(e, r3, t).next((e2) => {
      e2 || (n++, i.removeEntry(r3, SnapshotVersion.min()));
    })).next(() => i.apply(e)).next(() => n);
  }
  markPotentiallyOrphaned(e, t) {
    return this.Xr.set(t, e.currentSequenceNumber), PersistencePromise.resolve();
  }
  removeTarget(e, t) {
    const n = t.withSequenceNumber(e.currentSequenceNumber);
  ...
  addReference(e, t, n) {
    return this.Xr.set(n, e.currentSequenceNumber), PersistencePromise.resolve();
  }
  removeReference(e, t, n) {
    return this.Xr.set(n, e.currentSequenceNumber), PersistencePromise.resolve();
  }
  ...
  tr(e, t, n) {
    return PersistencePromise.or([() => this.persistence.zr(e, t), () => this.persistence.getTargetCache().containsKey(e, t), () => {
      const e2 = this.Xr.get(t);
...
var __PRIVATE_SchemaConverter = class {
  ...
  B(e, t, n, r2) {
    ...
    })), n < 5 && r2 >= 5 && (s = s.next(() => this.ei(i))), n < 6 && r2 >= 6 && (s = s.next(() => (function __PRIVATE_createDocumentGlobalStore(e2) {
      e2.createObjectStore("remoteDocumentGlobal");
    }(e), this.ti(i)))), n < 7 && r2 >= 7 && (s = s.next(() => this.ni(i))), n < 8 && r2 >= 8 && (s = s.next(() => this.ri(e, i))), n < 9 && r2 >= 9 && (s = s.next(() => {
    ...
    })), n < 10 && r2 >= 10 && (s = s.next(() => this.ii(i))), n < 11 && r2 >= 11 && (s = s.next(() => {
    ...
    }(e)).next(() => this.si(e, i)).next(() => e.deleteObjectStore("remoteDocuments"))), n < 14 && r2 >= 14 && (s = s.next(() => this.oi(e, i))), n < 15 && r2 >= 15 && (s = s.next(() => function __PRIVATE_createFieldIndex(e2) {
  ...
  oi(e, t) {
    const n = t.store("mutations"), r2 = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer), i = new __PRIVATE_MemoryPersistence(__PRIVATE_MemoryEagerDelegate.Jr, this.serializer.ht);
    return n.G().next((e2) => {
      const n2 = /* @__PURE__ */ new Map();
      return e2.forEach((e3) => {
        ...
        const s = new User(n3), o = __PRIVATE_IndexedDbDocumentOverlayCache.Pt(this.serializer, s), _ = i.getIndexManager(s), a = __PRIVATE_IndexedDbMutationQueue.Pt(s, this.serializer, _, i.referenceDelegate);
...
var Ee = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.";
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r2, i, s, o, _, a, u, c = 15) {
    if (this.allowTabSynchronization = e, this.persistenceKey = t, this.clientId = n, this._i = i, this.window = s, this.document = o, this.ai = a, this.ui = u, this.ci = c, this.qr = null, this.Qr = false, this.isPrimary = false, this.networkEnabled = true, /** Our window.unload handler, if registered. */
    this.li = null, this.inForeground = false, /** Our 'visibilitychange' listener if registered. */
    this.hi = null, /** The client metadata refresh task. */
    this.Pi = null, /** The last time we garbage collected the client metadata object store. */
    this.Ii = Number.NEGATIVE_INFINITY, /** A listener to notify on primary state changes. */
    this.di = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.C())
  ...
  start() {
    return this.Ri().then(() => {
      if (!this.isPrimary && !this.allowTabSynchronization)
        throw new FirestoreError(D2.FAILED_PRECONDITION, Ee);
      return this.Vi(), this.mi(), this.fi(), this.runTransaction("getHighestListenSequenceNumber", "readonly", (e) => this.Kr.getHighestSequenceNumber(e));
    }).then((e) => {
      this.qr = new __PRIVATE_ListenSequence(e, this.ai);
    }).then(() => {
      this.Qr = true;
  ...
  setNetworkEnabled(e) {
    ...
    this._i.enqueueAndForget(async () => {
  ...
  Ri() {
    return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (e) => __PRIVATE_clientMetadataStore(e).put({
      ...
      if (this.isPrimary)
        return this.pi(e).next((e2) => {
          e2 || (this.isPrimary = false, this._i.enqueueRetryable(() => this.di(false)));
        });
    }).next(() => this.yi(e)).next((t) => this.isPrimary && !t ? this.wi(e).next(() => false) : !!t && this.Si(e).next(() => true))).catch((e) => {
      ...
      this.isPrimary !== e && this._i.enqueueRetryable(() => this.di(e)), this.isPrimary = e;
    });
  }
  pi(e) {
    return __PRIVATE_primaryClientStore(e).get("owner").next((e2) => PersistencePromise.resolve(this.bi(e2)));
  }
  Di(e) {
   ...
   */
  async Ci() {
    if (this.isPrimary && !this.vi(this.Ii, 18e5)) {
      this.Ii = Date.now();
      const e = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (e2) => {
        ...
        return t.G().next((e3) => {
          const n = this.Fi(e3, 18e5), r2 = e3.filter((e4) => -1 === n.indexOf(e4));
          return PersistencePromise.forEach(r2, (e4) => t.delete(e4.clientId)).next(() => r2);
        });
      }).catch(() => []);
      if (this.Ai)
        for (const t of e)
          this.Ai.removeItem(this.Mi(t.clientId));
    }
  }
  /**
   ...
   */
    ...
    this.Pi = this._i.enqueueAfterDelay("client_metadata_refresh", 4e3, () => this.Ri().then(() => this.Ci()).then(() => this.fi()));
  }
  ...
  yi(e) {
    ...
    return __PRIVATE_primaryClientStore(e).get("owner").next((t) => {
      if (null !== t && this.vi(t.leaseTimestampMs, 5e3) && !this.xi(t.ownerId)) {
        if (this.bi(t) && this.networkEnabled)
          return true;
        if (!this.bi(t)) {
      ...
      return !(!this.networkEnabled || !this.inForeground) || __PRIVATE_clientMetadataStore(e).G().next((e2) => void 0 === this.Fi(e2, 5e3).find((e3) => {
  ...
  async shutdown() {
    this.Qr = false, this.Oi(), this.Pi && (this.Pi.cancel(), this.Pi = null), this.Ni(), this.Bi(), // Use `SimpleDb.runTransaction` directly to avoid failing if another tab
    ...
    await this.Ei.runTransaction("shutdown", "readwrite", ["owner", "clientMetadata"], (e) => {
      ...
      return this.wi(t).next(() => this.Di(t));
   ...
   */
  Fi(e, t) {
    return e.filter((e2) => this.vi(e2.updateTimeMs, t) && !this.xi(e2.clientId));
  }
  /**
   ...
   */
  ki() {
    return this.runTransaction("getActiveClients", "readonly", (e) => __PRIVATE_clientMetadataStore(e).G().next((e2) => this.Fi(e2, 18e5).map((e3) => e3.clientId)));
  }
  get started() {
    return this.Qr;
  }
  getMutationQueue(e, t) {
    return __PRIVATE_IndexedDbMutationQueue.Pt(e, this.serializer, t, this.referenceDelegate);
  }
  getTargetCache() {
    return this.Kr;
  }
  ...
  getIndexManager(e) {
    return new __PRIVATE_IndexedDbIndexManager(e, this.serializer.ht.databaseId);
  }
  getDocumentOverlayCache(e) {
    return __PRIVATE_IndexedDbDocumentOverlayCache.Pt(this.serializer, e);
  }
  getBundleCache() {
    return this.Ur;
  }
  runTransaction(e, t, n) {
    ...
    let s;
    return this.Ei.runTransaction(e, r2, i, (r3) => (s = new __PRIVATE_IndexedDbTransaction(r3, this.qr ? this.qr.next() : __PRIVATE_ListenSequence.ae), "readwrite-primary" === t ? this.pi(s).next((e2) => !!e2 || this.yi(s)).next((t2) => {
      if (!t2)
        throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = false, this._i.enqueueRetryable(() => this.di(false)), new FirestoreError(D2.FAILED_PRECONDITION, v2);
      return n(s);
    }).next((e2) => this.Si(s).next(() => e2)) : this.qi(s).next(() => n(s)))).then((e2) => (s.raiseOnCommittedEvent(), e2));
  }
  /**
  ...
  qi(e) {
    return __PRIVATE_primaryClientStore(e).get("owner").next((e2) => {
      if (null !== e2 && this.vi(e2.leaseTimestampMs, 5e3) && !this.xi(e2.ownerId) && !this.bi(e2) && !(this.ui || this.allowTabSynchronization && e2.allowTabSynchronization))
        throw new FirestoreError(D2.FAILED_PRECONDITION, Ee);
    });
  }
  /**
  ...
  wi(e) {
    ...
    return t.get("owner").next((e2) => this.bi(e2) ? (__PRIVATE_logDebug("IndexedDbPersistence", "Releasing primary lease."), t.delete("owner")) : PersistencePromise.resolve());
  }
  ...
  Vi() {
    null !== this.document && "function" == typeof this.document.addEventListener && (this.hi = () => {
      this._i.enqueueAndForget(() => (this.inForeground = "visible" === this.document.visibilityState, this.Ri()));
  ...
  mi() {
    ...
    "function" == typeof (null === (e = this.window) || void 0 === e ? void 0 : e.addEventListener) && (this.li = () => {
      ...
      this._i.enterRestrictedMode(
        /* purgeExistingTasks= */
        true
      ), this._i.enqueueAndForget(() => this.shutdown());
  ...
  xi(e) {
    var t;
    try {
      const n = null !== (null === (t = this.Ai) || void 0 === t ? void 0 : t.getItem(this.Mi(e)));
...
var __PRIVATE_LocalViewChanges = class ___PRIVATE_LocalViewChanges {
  constructor(e, t, n, r2) {
    this.targetId = e, this.fromCache = t, this.Qi = n, this.Ki = r2;
  }
  static $i(e, t) {
...
var __PRIVATE_QueryEngine = class {
  ...
  initialize(e, t) {
    this.ji = e, this.indexManager = t, this.Ui = true;
  }
  ...
  getDocumentsMatchingQuery(e, t, n, r2) {
    ...
    return this.Hi(e, t).next((e2) => {
      ...
      return this.Yi(e, t, n2).next((r3) => {
        if (i.result = r3, this.Wi)
          return this.Zi(e, t, n2, r3.size);
      });
    }).next(() => i.result);
  }
  Zi(e, t, n, r2) {
    return n.documentReadCount < this.Gi ? (__PRIVATE_getLogLevel() <= LogLevel.DEBUG && __PRIVATE_logDebug("QueryEngine", "SDK will not create cache indexes for query:", __PRIVATE_stringifyQuery(t), "since it only creates cache indexes for collection contains", "more than or equal to", this.Gi, "documents"), PersistencePromise.resolve()) : (__PRIVATE_getLogLevel() <= LogLevel.DEBUG && __PRIVATE_logDebug("QueryEngine", "Query:", __PRIVATE_stringifyQuery(t), "scans", n.documentReadCount, "local documents and returns", r2, "documents as results."), n.documentReadCount > this.zi * r2 ? (__PRIVATE_getLogLevel() <= LogLevel.DEBUG && __PRIVATE_logDebug("QueryEngine", "The SDK decides to create cache indexes for query:", __PRIVATE_stringifyQuery(t), "as using cache indexes may help improve performance."), this.indexManager.createTargetIndexes(e, __PRIVATE_queryToTarget(t))) : PersistencePromise.resolve());
  }
  /**
  ...
  Hi(e, t) {
    ...
    (t = __PRIVATE_queryWithLimit(
      ...
      return this.ji.getDocuments(e, i).next((r4) => this.indexManager.getMinOffset(e, n).next((n2) => {
        const s = this.Xi(t, r4);
        return this.es(t, s, i, n2.readTime) ? this.Hi(e, __PRIVATE_queryWithLimit(
          t,
          null,
          "F"
          /* LimitType.First */
   ...
   */
  Ji(e, t, n, r2) {
    return __PRIVATE_queryMatchesAllDocuments(t) || r2.isEqual(SnapshotVersion.min()) ? PersistencePromise.resolve(null) : this.ji.getDocuments(e, n).next((i) => {
      const s = this.Xi(t, i);
      return this.es(t, s, n, r2) ? PersistencePromise.resolve(null) : (__PRIVATE_getLogLevel() <= LogLevel.DEBUG && __PRIVATE_logDebug("QueryEngine", "Re-using previous result from %s to execute query: %s", r2.toString(), __PRIVATE_stringifyQuery(t)), this.ts(e, s, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(r2, -1)).next((e2) => e2));
    });
  }
   ...
   */
  ts(e, t, n, r2) {
    return this.ji.getDocumentsMatchingQuery(e, n, r2).next((e2) => (
...
var __PRIVATE_LocalStoreImpl = class {
  constructor(e, t, n, r2) {
    this.persistence = e, this.ns = t, this.serializer = r2, /**
     * Maps a targetID to data about its target.
     *
     * PORTING NOTE: We are using an immutable data structure on Web to make re-runs
     * of `applyRemoteEvent()` idempotent.
     */
    this.rs = new SortedMap(__PRIVATE_primitiveComparator), /** Maps a target to its targetID. */
    // TODO(wuandy): Evaluate if TargetId can be part of Target.
    this.ss = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), __PRIVATE_targetEquals), /**
     * A per collection group index of the last read time processed by
     * `getNewDocumentChanges()`.
     *
     * PORTING NOTE: This is only used for multi-tab synchronization.
     */
    this.os = /* @__PURE__ */ new Map(), this._s = e.getRemoteDocumentCache(), this.Kr = e.getTargetCache(), this.Ur = e.getBundleCache(), this.us(n);
  }
  us(e) {
    this.documentOverlayCache = this.persistence.getDocumentOverlayCache(e), this.indexManager = this.persistence.getIndexManager(e), this.mutationQueue = this.persistence.getMutationQueue(e, this.indexManager), this.localDocuments = new LocalDocumentsView(this._s, this.mutationQueue, this.documentOverlayCache, this.indexManager), this._s.setIndexManager(this.indexManager), this.ns.initialize(this.localDocuments, this.indexManager);
  }
  collectGarbage(e) {
    return this.persistence.runTransaction("Collect garbage", "readwrite-primary", (t) => e.collect(t, this.rs));
  }
};
...
async function __PRIVATE_localStoreHandleUserChange(e, t) {
  ...
  return await n.persistence.runTransaction("Handle user change", "readonly", (e2) => {
    let r2;
    return n.mutationQueue.getAllMutationBatches(e2).next((i) => (r2 = i, n.us(t), n.mutationQueue.getAllMutationBatches(e2))).next((t2) => {
      const i = [], s = [];
...
function __PRIVATE_localStoreAcknowledgeBatch(e, t) {
  ...
  return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (e2) => {
    const r2 = t.batch.keys(), i = n._s.newChangeBuffer({
      trackRemovals: true
    });
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
  ...
  return n.persistence.runTransaction("Allocate target", "readwrite", (e2) => {
    ...
    const r2 = n.rs.get(e2.targetId);
    return (null === r2 || e2.snapshotVersion.compareTo(r2.snapshotVersion) > 0) && (n.rs = n.rs.insert(e2.targetId, e2), n.ss.set(t, e2.targetId)), e2;
  });
}
async function __PRIVATE_localStoreReleaseTarget(e, t, n) {
  const r2 = __PRIVATE_debugCast(e), i = r2.rs.get(t), s = n ? "readwrite" : "readwrite-primary";
  try {
  ...
  r2.rs = r2.rs.remove(t), r2.ss.delete(i.target);
}
function __PRIVATE_localStoreExecuteQuery(e, t, n) {
  ...
  return r2.persistence.runTransaction(
    ...
    (e2) => function __PRIVATE_localStoreGetTargetData(e3, t2, n2) {
      const r3 = __PRIVATE_debugCast(e3), i2 = r3.ss.get(n2);
      return void 0 !== i2 ? PersistencePromise.resolve(r3.rs.get(i2)) : r3.Kr.getTargetData(t2, n2);
    ...
    }).next(() => r2.ns.getDocumentsMatchingQuery(e2, t, n ? i : SnapshotVersion.min(), n ? s : __PRIVATE_documentKeySet())).next((e3) => (__PRIVATE_setMaxReadTime(r2, __PRIVATE_queryCollectionGroup(t), e3), {
      documents: e3,
      Ps: s
    }))
  );
...
function __PRIVATE_localStoreGetCachedTarget(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = __PRIVATE_debugCast(n.Kr), i = n.rs.get(t);
...
function __PRIVATE_localStoreGetNewDocumentChanges(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = n.os.get(t) || SnapshotVersion.min();
  return n.persistence.runTransaction("Get new document changes", "readonly", (e2) => n._s.getAllFromCollectionGroup(
    e2,
    t,
...
async function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, r2) {
  ...
  return i.persistence.runTransaction("Apply bundle documents", "readwrite", (e2) => __PRIVATE_populateDocumentChangeBuffer(e2, _, o).next((t2) => (_.apply(e2), t2)).next((t2) => i.Kr.removeMatchingKeysForTargetId(e2, a.targetId).next(() => i.Kr.addMatchingKeys(e2, s, a.targetId)).next(() => i.localDocuments.getLocalViewOfDocuments(e2, t2.ls, t2.hs)).next(() => t2.ls)));
}
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
  ...
  return i.persistence.runTransaction("Save named query", "readwrite", (e2) => {
    ...
    if (r2.snapshotVersion.compareTo(s) >= 0)
      return i.Ur.saveNamedQuery(e2, t);
    const o = r2.withResumeToken(ByteString.EMPTY_BYTE_STRING, s);
    return i.rs = i.rs.insert(o.targetId, o), i.Kr.updateTargetData(e2, o).next(() => i.Kr.removeMatchingKeysForTargetId(e2, r2.targetId)).next(() => i.Kr.addMatchingKeys(e2, n, r2.targetId)).next(() => i.Ur.saveNamedQuery(e2, t));
  });
}
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r2, i) {
    this.window = e, this._i = t, this.persistenceKey = n, this.fs = r2, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.gs = this.ps.bind(this), this.ys = new SortedMap(__PRIVATE_primitiveComparator), this.started = false, /**
     * Captures WebStorage events that occur before `start()` is called. These
     * events are replayed once `WebStorageSharedClientState` is started.
     */
    this.ws = [];
    const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.Ss = createWebStorageClientStateKey(this.persistenceKey, this.fs), this.bs = /** Assembles the key for the current sequence number. */
    function createWebStorageSequenceNumberKey(e2) {
      return `firestore_sequence_number_${e2}`;
    }(this.persistenceKey), this.ys = this.ys.insert(this.fs, new __PRIVATE_LocalClientState()), this.Ds = new RegExp(`^firestore_clients_${s}_([^_]*)$`), this.Cs = new RegExp(`^firestore_mutations_${s}_(\\d+)(?:_(.*))?$`), this.vs = new RegExp(`^firestore_targets_${s}_(\\d+)$`), this.Fs = /** Assembles the key for the online state of the primary tab. */
    function createWebStorageOnlineStateKey(e2) {
      return `firestore_online_state_${e2}`;
    }(this.persistenceKey), this.Ms = function createBundleLoadedKey(e2) {
  ...
  async start() {
    const e = await this.syncEngine.ki();
    for (const t2 of e) {
      if (t2 === this.fs)
        continue;
    ...
    this.xs();
    const t = this.storage.getItem(this.Fs);
    if (t) {
      const e2 = this.Os(t);
      e2 && this.Ns(e2);
    }
    for (const e2 of this.ws)
      this.ps(e2);
    this.ws = [], // Register a window unload hook to remove the client metadata entry from
  ...
  addLocalQueryTarget(e) {
    ...
    return this.qs.Rs(e), this.xs(), t;
  }
  removeLocalQueryTarget(e) {
    this.qs.Vs(e), this.xs();
  }
  ...
  shutdown() {
    this.started && (this.window.removeEventListener("storage", this.gs), this.removeItem(this.Ss), this.started = false);
  }
  getItem(e) {
  ...
  ps(e) {
    ...
    if (t.storageArea === this.storage) {
      if (__PRIVATE_logDebug("SharedClientState", "EVENT", t.key, t.newValue), t.key === this.Ss)
      ...
      this._i.enqueueRetryable(async () => {
        if (this.started) {
          if (null !== t.key) {
            if (this.Ds.test(t.key)) {
              if (null == t.newValue) {
                const e2 = this.Us(t.key);
                return this.Ws(e2, null);
              }
              {
                const e2 = this.Gs(t.key, t.newValue);
                if (e2)
                  return this.Ws(e2.clientId, e2);
              }
              ...
              const e2 = this.Ys(t.newValue);
              await Promise.all(e2.map((e3) => this.syncEngine.Zs(e3)));
            }
          }
        } else
          this.ws.push(t);
   ...
   */
  zs(e, t) {
    const n = this.Cs.exec(e), r2 = Number(n[1]), i = void 0 !== n[2] ? n[2] : null;
   ...
   */
  Hs(e, t) {
    const n = this.vs.exec(e), r2 = Number(n[1]);
  ...
  async js(e) {
    if (e.user.uid === this.currentUser.uid)
      return this.syncEngine.Xs(e.batchId, e.state, e.error);
    __PRIVATE_logDebug("SharedClientState", `Ignoring mutation for non-active user ${e.user.uid}`);
  }
  Js(e) {
    return this.syncEngine.eo(e.targetId, e.state, e.error);
  }
  Ws(e, t) {
    const n = t ? this.ys.insert(e, t) : this.ys.remove(e), r2 = this.Bs(this.ys), i = this.Bs(n), s = [], o = [];
    return i.forEach((e2) => {
      r2.has(e2) || s.push(e2);
    }), r2.forEach((e2) => {
      i.has(e2) || o.push(e2);
    }), this.syncEngine.no(s, o).then(() => {
      this.ys = n;
    });
  }
  Ns(e) {
...
var __PRIVATE_MemorySharedClientState = class {
  constructor() {
    this.ro = new __PRIVATE_LocalClientState(), this.io = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
  }
  addPendingMutation(e) {
  }
  updateMutationState(e, t, n) {
  ...
  addLocalQueryTarget(e) {
    return this.ro.Rs(e), this.io[e] || "not-current";
  }
  updateQueryState(e, t, n) {
    this.io[e] = t;
  }
  ...
  isLocalQueryTarget(e) {
    return this.ro.activeTargetIds.has(e);
  }
  clearQueryState(e) {
    delete this.io[e];
  }
  ...
  start() {
    return this.ro = new __PRIVATE_LocalClientState(), Promise.resolve();
  }
  handleUserChange(e, t, n) {
  }
  setOnlineState(e) {
...
var __PRIVATE_BrowserConnectivityMonitor = class {
  constructor() {
    this.oo = () => this._o(), this.ao = () => this.uo(), this.co = [], this.lo();
  }
  so(e) {
    this.co.push(e);
  }
...
class __PRIVATE_RestConnection {
  constructor(e) {
    ...
    this.po = t + "://" + e.host, this.yo = `projects/${n}/databases/${r2}`, this.wo = "(default)" === this.databaseId.database ? `project_id=${n}` : `project_id=${n}&database_id=${r2}`;
  }
  get So() {
    return false;
  }
  bo(e, t, n, r2, i) {
    const s = __PRIVATE_generateUniqueDebugId(), o = this.Do(e, t);
    __PRIVATE_logDebug("RestConnection", `Sending RPC '${e}' ${s}:`, o, n);
    const _ = {
      "google-cloud-resource-prefix": this.yo,
      "x-goog-request-params": this.wo
    };
    return this.Co(_, r2, i), this.vo(e, o, _, n).then((t2) => (__PRIVATE_logDebug("RestConnection", `Received RPC '${e}' ${s}: `, t2), t2), (t2) => {
      throw __PRIVATE_logWarn("RestConnection", `RPC '${e}' ${s} failed with error: `, t2, "url: ", o, "request:", n), t2;
    });
  }
  Fo(e, t, n, r2, i, s) {
    return this.bo(e, t, n, r2, i);
  }
  /**
  ...
  Mo(e, t, n) {
    const r2 = __PRIVATE_generateUniqueDebugId(), i = [this.po, "/", "google.firestore.v1.Firestore", "/", e, "/channel"], s = createWebChannelTransport(), o = getStatEventTarget(), _ = {
    ...
    void 0 !== a && (_.longPollingTimeout = Math.round(1e3 * a)), this.useFetchStreams && (_.useFetchStreams = true), this.Co(_.initMessageHeaders, t, n), // Sending the custom headers we just added to request.initMessageHeaders
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      h || (h = true, __PRIVATE_logDebug(Ve, `RPC '${e}' stream ${r2} transport closed`), P2.mo());
    }), __PRIVATE_unguardedEventListen(c, WebChannel.EventType.ERROR, (t2) => {
      h || (h = true, __PRIVATE_logWarn(Ve, `RPC '${e}' stream ${r2} transport errored:`, t2), P2.mo(new FirestoreError(D2.UNAVAILABLE, "The operation could not be completed")));
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          h = true, P2.mo(new FirestoreError(n3, i3)), c.close();
        } else
          __PRIVATE_logDebug(Ve, `RPC '${e}' stream ${r2} received:`, i2), P2.fo(i2);
      }
...
var __PRIVATE_ExponentialBackoff = class {
  constructor(e, t, n = 1e3, r2 = 1.5, i = 6e4) {
    this._i = e, this.timerId = t, this.xo = n, this.Oo = r2, this.No = i, this.Bo = 0, this.Lo = null, /** The last backoff attempt, as epoch milliseconds. */
  ...
  Qo(e) {
    this.cancel();
    const t = Math.floor(this.Bo + this.Ko()), n = Math.max(0, Date.now() - this.ko), r2 = Math.max(0, t - n);
    r2 > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${r2} ms (base delay: ${this.Bo} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`), this.Lo = this._i.enqueueAfterDelay(this.timerId, r2, () => (this.ko = Date.now(), e())), // Apply backoff factor to determine next delay and ensure it is within
    // bounds.
...
var __PRIVATE_PersistentStream = class {
  constructor(e, t, n, r2, i, s, o, _) {
    this._i = e, this.Uo = n, this.Wo = r2, this.connection = i, this.authCredentialsProvider = s, this.appCheckCredentialsProvider = o, this.listener = _, this.state = 0, /**
     * A close count that's incremented every time the stream is closed; used by
     * getCloseGuardedDispatcher() to invalidate callbacks that happen after
     * close.
     */
    this.Go = 0, this.zo = null, this.jo = null, this.stream = null, this.Ho = new __PRIVATE_ExponentialBackoff(e, t);
  }
  /**
   ...
   */
  Jo() {
    return 1 === this.state || 5 === this.state || this.Yo();
  }
  /**
   ...
   */
  start() {
    4 !== this.state ? this.auth() : this.Zo();
  }
  /**
   ...
   */
  e_() {
    this.Yo() && null === this.zo && (this.zo = this._i.enqueueAfterDelay(this.Uo, 6e4, () => this.t_()));
  }
  /** Sends a message to the underlying stream. */
  n_(e) {
    this.r_(), this.stream.send(e);
  }
   ...
   */
  async close(e, t) {
    this.r_(), this.i_(), this.Ho.cancel(), // Invalidates any stream-related callbacks (e.g. from auth or the
    ...
    this.Go++, 4 !== e ? (
      ...
      (__PRIVATE_logError(t.toString()), __PRIVATE_logError("Using maximum backoff delay to prevent overloading the backend."), this.Ho.qo())
    ...
    null !== this.stream && (this.s_(), this.stream.close(), this.stream = null), // This state must be assigned before calling onClose() to allow the callback to
  ...
  auth() {
    this.state = 1;
    const e = this.o_(this.Go), t = this.Go;
  ...
  __(e, t) {
    const n = this.o_(this.Go);
    this.stream = this.u_(e, t), this.stream.Io(() => {
      n(() => (this.state = 2, this.jo = this._i.enqueueAfterDelay(this.Wo, 1e4, () => (this.Yo() && (this.state = 3), Promise.resolve())), this.listener.Io()));
    }), this.stream.Eo((e2) => {
      n(() => this.a_(e2));
  ...
  o_(e) {
    return (t) => {
      this._i.enqueueAndForget(() => this.Go === e ? t() : (__PRIVATE_logDebug("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), Promise.resolve()));
    };
  }
};
var __PRIVATE_PersistentListenStream = class extends __PRIVATE_PersistentStream {
  ...
  u_(e, t) {
    return this.connection.Mo("Listen", e, t);
  }
  onMessage(e) {
    this.Ho.reset();
  ...
  h_(e) {
    const t = {};
    t.database = __PRIVATE_getEncodedDatabaseId(this.serializer), t.removeTarget = e, this.n_(t);
  }
};
var __PRIVATE_PersistentWriteStream = class extends __PRIVATE_PersistentStream {
  constructor(e, t, n, r2, i, s) {
    super(e, "write_stream_connection_backoff", "write_stream_idle", "health_check_timeout", t, n, r2, s), this.serializer = i, this.P_ = false;
  }
  /**
  ...
  start() {
    this.P_ = false, this.lastStreamToken = void 0, super.start();
  }
  s_() {
    this.P_ && this.d_([]);
  }
  u_(e, t) {
    return this.connection.Mo("Write", e, t);
  }
  onMessage(e) {
    if (
      // Always capture the last stream token.
      __PRIVATE_hardAssert(!!e.streamToken), this.lastStreamToken = e.streamToken, this.P_
    ) {
      this.Ho.reset();
      const t = __PRIVATE_fromWriteResults(e.writeResults, e.commitTime), n = __PRIVATE_fromVersion(e.commitTime);
      return this.listener.T_(n, t);
    }
    return __PRIVATE_hardAssert(!e.writeResults || 0 === e.writeResults.length), this.P_ = true, this.listener.E_();
  }
  /**
  ...
  A_() {
    const e = {};
    e.database = __PRIVATE_getEncodedDatabaseId(this.serializer), this.n_(e);
  }
...
var __PRIVATE_DatastoreImpl = class extends class Datastore {
  ...
  constructor(e, t, n, r2) {
    super(), this.authCredentials = e, this.appCheckCredentials = t, this.connection = n, this.serializer = r2, this.R_ = false;
  }
  V_() {
    if (this.R_)
  ...
  bo(e, t, n) {
    return this.V_(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([r2, i]) => this.connection.bo(e, t, n, r2, i)).catch((e2) => {
  ...
  Fo(e, t, n, r2) {
    return this.V_(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([i, s]) => this.connection.Fo(e, t, n, i, s, r2)).catch((e2) => {
      throw "FirebaseError" === e2.name ? (e2.code === D2.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), e2) : new FirestoreError(D2.UNKNOWN, e2.toString());
    });
  }
  terminate() {
...
async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
  var r2;
  const i = __PRIVATE_debugCast(e), { request: s, m_: o } = function __PRIVATE_toRunAggregationQueryRequest(e2, t2, n2) {
    ...
    return t2.de || // Do not include implicit order-bys for aggregate queries.
    (t2.de = __PRIVATE__queryToTarget(t2, e2.explicitOrderBy)), t2.de;
  }(t), n), _ = s.parent;
  i.connection.So || delete s.parent;
  const a = (await i.Fo(
    "RunAggregationQuery",
    _,
    s,
...
var __PRIVATE_OnlineStateTracker = class {
  ...
  y_() {
    0 === this.f_ && (this.w_(
      "Unknown"
      /* OnlineState.Unknown */
    ), this.g_ = this.asyncQueue.enqueueAfterDelay("online_state_timeout", 1e4, () => (this.g_ = null, this.S_("Backend didn't respond within 10 seconds."), this.w_(
      "Offline"
      /* OnlineState.Offline */
    ), Promise.resolve())));
  }
   ...
   */
  b_(e) {
    "Online" === this.state ? this.w_(
      "Unknown"
      /* OnlineState.Unknown */
    ) : (this.f_++, this.f_ >= 1 && (this.D_(), this.S_(`Connection failed 1 times. Most recent error: ${e.toString()}`), this.w_(
      "Offline"
      /* OnlineState.Offline */
    )));
  }
   ...
   */
  set(e) {
    this.D_(), this.f_ = 0, "Online" === e && // We've connected to watch at least once. Don't warn the developer
    // about being offline going forward.
    (this.p_ = false), this.w_(e);
  }
  w_(e) {
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;
    this.p_ ? (__PRIVATE_logError(t), this.p_ = false) : __PRIVATE_logDebug("OnlineStateTracker", t);
  }
  D_() {
...
var __PRIVATE_RemoteStoreImpl = class {
  constructor(e, t, n, r2, i) {
     ...
     */
    this.v_ = /* @__PURE__ */ new Map(), /**
     * A set of reasons for why the RemoteStore may be offline. If empty, the
     * RemoteStore may start its network connections.
     */
    this.F_ = /* @__PURE__ */ new Set(), /**
     ...
     */
    this.M_ = [], this.x_ = i, this.x_.so((e2) => {
      n.enqueueAndForget(async () => {
        __PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug("RemoteStore", "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e3) {
          ...
          ), await __PRIVATE_disableNetworkInternal(t2), t2.O_.set(
            "Unknown"
            /* OnlineState.Unknown */
          ), t2.F_.delete(
            4
    ...
    }), this.O_ = new __PRIVATE_OnlineStateTracker(n, r2);
  }
};
...
function __PRIVATE_remoteStoreListen(e, t) {
  const n = __PRIVATE_debugCast(e);
  n.v_.has(t.targetId) || // Mark this as something the client is currently listening for.
  (n.v_.set(t.targetId, t), __PRIVATE_shouldStartWatchStream(n) ? (
    // The listen will be sent in onWatchStreamOpen
    __PRIVATE_startWatchStream(n)
  ) : __PRIVATE_ensureWatchStream(n).Yo() && __PRIVATE_sendWatchRequest(n, t));
}
function __PRIVATE_remoteStoreUnlisten(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = __PRIVATE_ensureWatchStream(n);
  n.v_.delete(t), r2.Yo() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.v_.size && (r2.Yo() ? r2.e_() : __PRIVATE_canUseNetwork(n) && // Revert to OnlineState.Unknown if the watch stream is not open and we
...
function __PRIVATE_sendWatchRequest(e, t) {
  if (e.N_.Le(t.targetId), t.resumeToken.approximateByteSize() > 0 || t.snapshotVersion.compareTo(SnapshotVersion.min()) > 0) {
    const n = e.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;
    t = t.withExpectedCount(n);
  }
  __PRIVATE_ensureWatchStream(e).l_(t);
}
function __PRIVATE_sendUnwatchRequest(e, t) {
  e.N_.Le(t), __PRIVATE_ensureWatchStream(e).h_(t);
}
function __PRIVATE_startWatchStream(e) {
  e.N_ = new __PRIVATE_WatchChangeAggregator({
    getRemoteKeysForTarget: (t) => e.remoteSyncer.getRemoteKeysForTarget(t),
    lt: (t) => e.v_.get(t) || null,
    st: () => e.datastore.serializer.databaseId
  }), __PRIVATE_ensureWatchStream(e).start(), e.O_.y_();
}
function __PRIVATE_shouldStartWatchStream(e) {
  return __PRIVATE_canUseNetwork(e) && !__PRIVATE_ensureWatchStream(e).Jo() && e.v_.size > 0;
}
function __PRIVATE_canUseNetwork(e) {
  return 0 === __PRIVATE_debugCast(e).F_.size;
}
...
async function __PRIVATE_onWatchStreamClose(e, t) {
  ...
  __PRIVATE_shouldStartWatchStream(e) ? (e.O_.b_(t), __PRIVATE_startWatchStream(e)) : (
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
    ...
    try {
      ...
      async function __PRIVATE_handleTargetError(e2, t2) {
        ...
        for (const r2 of t2.targetIds)
          e2.v_.has(r2) && (await e2.remoteSyncer.rejectListen(r2, n2), e2.v_.delete(r2), e2.N_.removeTarget(r2));
      }(e, t);
    } catch (n2) {
  ...
  else if (t instanceof __PRIVATE_DocumentWatchChange ? e.N_.Ge(t) : t instanceof __PRIVATE_ExistenceFilterChange ? e.N_.Xe(t) : e.N_.He(t), !n.isEqual(SnapshotVersion.min()))
    try {
      ...
      */
      function __PRIVATE_raiseWatchSnapshot(e2, t3) {
        const n2 = e2.N_._t(t3);
        return n2.targetChanges.forEach((n3, r2) => {
          if (n3.resumeToken.approximateByteSize() > 0) {
            const i = e2.v_.get(r2);
            i && e2.v_.set(r2, i.withResumeToken(n3.resumeToken, t3));
          }
        }), // Re-establish listens for the targets that have been invalidated by
        // existence filter mismatches.
        n2.targetMismatches.forEach((t4, n3) => {
          const r2 = e2.v_.get(t4);
          if (!r2)
            return;
          e2.v_.set(t4, r2.withResumeToken(ByteString.EMPTY_BYTE_STRING, r2.snapshotVersion)), // Cause a hard reset by unwatching and rewatching immediately, but
...
async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  ...
  await __PRIVATE_disableNetworkInternal(e), e.O_.set(
    "Offline"
    /* OnlineState.Offline */
  ...
  e.asyncQueue.enqueueRetryable(async () => {
    __PRIVATE_logDebug("RemoteStore", "Retrying IndexedDB access"), await n(), e.F_.delete(
      1
      /* OfflineCause.IndexedDbFailed */
...
async function __PRIVATE_fillWritePipeline(e) {
  ...
  let r2 = t.C_.length > 0 ? t.C_[t.C_.length - 1].batchId : -1;
...
function __PRIVATE_canAddToWritePipeline(e) {
  return __PRIVATE_canUseNetwork(e) && e.C_.length < 10;
}
function __PRIVATE_addToWritePipeline(e, t) {
  e.C_.push(t);
  const n = __PRIVATE_ensureWriteStream(e);
  n.Yo() && n.I_ && n.d_(t.mutations);
}
function __PRIVATE_shouldStartWriteStream(e) {
  return __PRIVATE_canUseNetwork(e) && !__PRIVATE_ensureWriteStream(e).Jo() && e.C_.length > 0;
}
function __PRIVATE_startWriteStream(e) {
  __PRIVATE_ensureWriteStream(e).start();
}
async function __PRIVATE_onWriteStreamOpen(e) {
  __PRIVATE_ensureWriteStream(e).A_();
}
...
async function __PRIVATE_onMutationResult(e, t, n) {
  const r2 = e.C_.shift(), i = MutationBatchResult.from(r2, t, n);
...
async function __PRIVATE_onWriteStreamClose(e, t) {
  t && __PRIVATE_ensureWriteStream(e).I_ && // This error affects the actual write.
  await async function __PRIVATE_handleWriteError(e2, t2) {
    if (function __PRIVATE_isPermanentWriteError(e3) {
      ...
      const n = e2.C_.shift();
      __PRIVATE_ensureWriteStream(e2).Xo(), await __PRIVATE_executeWithRecovery(e2, () => e2.remoteSyncer.rejectFailedWrite(n.batchId, t2)), // It's possible that with the completion of this mutation
...
async function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
  ...
  n.O_.set(
    "Unknown"
    /* OnlineState.Unknown */
  ), await n.remoteSyncer.handleCredentialChange(t), n.F_.delete(
    3
    /* OfflineCause.CredentialChange */
...
async function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
  ...
  ), await __PRIVATE_enableNetworkInternal(n)) : t || (n.F_.add(
    2
    /* OfflineCause.IsSecondary */
  ), await __PRIVATE_disableNetworkInternal(n), n.O_.set(
    "Unknown"
    /* OnlineState.Unknown */
  ));
}
function __PRIVATE_ensureWatchStream(e) {
  ...
  (e.B_ = function __PRIVATE_newPersistentWatchStream(e2, t, n) {
    ...
    return r2.V_(), new __PRIVATE_PersistentListenStream(t, r2.connection, r2.authCredentials, r2.appCheckCredentials, r2.serializer, n);
  }(e.datastore, e.asyncQueue, {
    Io: __PRIVATE_onWatchStreamOpen.bind(null, e),
    Eo: __PRIVATE_onWatchStreamClose.bind(null, e),
    c_: __PRIVATE_onWatchStreamChange.bind(null, e)
  }), e.M_.push(async (t) => {
    t ? (e.B_.Xo(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.O_.set(
      "Unknown"
      /* OnlineState.Unknown */
...
function __PRIVATE_ensureWriteStream(e) {
  ...
  (e.L_ = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    const r2 = __PRIVATE_debugCast(e2);
    return r2.V_(), new __PRIVATE_PersistentWriteStream(t, r2.connection, r2.authCredentials, r2.appCheckCredentials, r2.serializer, n);
  }(e.datastore, e.asyncQueue, {
    ...
    t ? (e.L_.Xo(), // This will start the write stream if necessary.
    await __PRIVATE_fillWritePipeline(e)) : (await e.L_.stop(), e.C_.length > 0 && (__PRIVATE_logDebug("RemoteStore", `Stopping write stream with ${e.C_.length} pending writes`), e.C_ = []));
  })), e.L_;
}
...
var __PRIVATE_DocumentChangeSet = class {
  constructor() {
    this.k_ = new SortedMap(DocumentKey.comparator);
  }
  track(e) {
    const t = e.doc.key, n = this.k_.get(t);
    n ? (
      // Merge the new change with the existing change.
      0 !== e.type && 3 === n.type ? this.k_ = this.k_.insert(t, e) : 3 === e.type && 1 !== n.type ? this.k_ = this.k_.insert(t, {
        type: n.type,
        doc: e.doc
      }) : 2 === e.type && 2 === n.type ? this.k_ = this.k_.insert(t, {
        type: 2,
        doc: e.doc
      }) : 2 === e.type && 0 === n.type ? this.k_ = this.k_.insert(t, {
        type: 0,
        doc: e.doc
      }) : 1 === e.type && 0 === n.type ? this.k_ = this.k_.remove(t) : 1 === e.type && 2 === n.type ? this.k_ = this.k_.insert(t, {
        type: 1,
        doc: n.doc
      }) : 0 === e.type && 1 === n.type ? this.k_ = this.k_.insert(t, {
        type: 2,
        doc: e.doc
      }) : (
    ...
    ) : this.k_ = this.k_.insert(t, e);
  }
  q_() {
    const e = [];
    return this.k_.inorderTraversal((t, n) => {
      e.push(n);
    }), e;
  }
};
...
var __PRIVATE_EventManagerImpl = class {
  constructor() {
    this.queries = new ObjectMap((e) => __PRIVATE_canonifyQuery(e), __PRIVATE_queryEquals), this.onlineState = "Unknown", this.K_ = /* @__PURE__ */ new Set();
  }
};
async function __PRIVATE_eventManagerListen(e, t) {
  ...
  t.U_(n.onlineState), s.Q_) {
    t.W_(s.Q_) && __PRIVATE_raiseSnapshotsInSyncEvent(n);
  }
}
...
var __PRIVATE_QueryListener = class {
  constructor(e, t, n) {
    this.query = e, this.G_ = t, /**
     * Initial snapshots (e.g. from cache) may not be propagated to the wrapped
     * observer. This flag is set to true once we've actually raised an event.
     */
    this.z_ = false, this.j_ = null, this.onlineState = "Unknown", this.options = n || {};
  }
  /**
  ...
  W_(e) {
    ...
    let t = false;
    return this.z_ ? this.H_(e) && (this.G_.next(e), t = true) : this.J_(e, this.onlineState) && (this.Y_(e), t = true), this.j_ = e, t;
  }
  onError(e) {
    this.G_.error(e);
  }
  ...
  U_(e) {
    this.onlineState = e;
    let t = false;
    return this.j_ && !this.z_ && this.J_(this.j_, e) && (this.Y_(this.j_), t = true), t;
  }
  J_(e, t) {
    if (!e.fromCache)
      return true;
  ...
  Y_(e) {
    e = ViewSnapshot.fromInitialDocuments(e.query, e.docs, e.mutatedKeys, e.fromCache, e.hasCachedResults), this.z_ = true, this.G_.next(e);
  }
};
...
var __PRIVATE_BundleConverterImpl = class {
   ...
   */
  ds(e) {
    return e.metadata.exists ? __PRIVATE_fromDocument(this.serializer, e.document, false) : MutableDocument.newNoDocument(this.Is(e.metadata.name), this.Ts(e.metadata.readTime));
  }
  Ts(e) {
...
var __PRIVATE_BundleLoader = class {
  constructor(e, t, n) {
    this.ta = e, this.localStore = t, this.serializer = n, /** Batched queries to be saved into storage */
  ...
  na(e) {
    ...
    if (e.X_.namedQuery)
      this.queries.push(e.X_.namedQuery);
      ...
      e.X_.document && (this.documents[this.documents.length - 1].document = e.X_.document, ++t);
  ...
  ra(e) {
    ...
    for (const r2 of e)
      if (r2.metadata.queries) {
        const e2 = n.Is(r2.metadata.name);
   ...
   */
  async complete() {
    const e = await __PRIVATE_localStoreApplyBundledDocuments(this.localStore, new __PRIVATE_BundleConverterImpl(this.serializer), this.documents, this.ta.id), t = this.ra(this.documents);
...
var __PRIVATE_View = class {
  constructor(e, t) {
    this.query = e, this.oa = t, this._a = null, this.hasCachedResults = false, /**
    ...
    this.mutatedKeys = __PRIVATE_documentKeySet(), this.ua = __PRIVATE_newQueryComparator(e), this.ca = new DocumentSet(this.ua);
  }
  /**
   ...
   */
  ha(e, t) {
    const n = t ? t.Pa : new __PRIVATE_DocumentChangeSet(), r2 = t ? t.ca : this.ca;
    ...
    if (e.inorderTraversal((e2, t2) => {
      ...
      if (u && c) {
        u.data.isEqual(c.data) ? l2 !== h && (n.track({
          type: 3,
          doc: c
        }), P2 = true) : this.Ia(u, c) || (n.track({
          type: 2,
          doc: c
        }), P2 = true, (_ && this.ua(c, _) > 0 || a && this.ua(c, a) < 0) && // This doc moved from inside the limit to outside the limit.
  ...
  applyChanges(e, t, n) {
    ...
    }(e2.type, t2.type) || this.ua(e2.doc, t2.doc)), this.da(n);
    const s = t ? this.Ta() : [], o = 0 === this.aa.size && this.current ? 1 : 0, _ = o !== this._a;
    if (this._a = o, 0 !== i.length || _) {
      return {
   ...
   */
  da(e) {
    e && (e.addedDocuments.forEach((e2) => this.oa = this.oa.add(e2)), e.modifiedDocuments.forEach((e2) => {
    }), e.removedDocuments.forEach((e2) => this.oa = this.oa.delete(e2)), this.current = e.current);
  }
  Ta() {
    if (!this.current)
      return [];
    const e = this.aa;
    this.aa = __PRIVATE_documentKeySet(), this.ca.forEach((e2) => {
      this.Aa(e2.key) && (this.aa = this.aa.add(e2.key));
    });
    const t = [];
    return e.forEach((e2) => {
      this.aa.has(e2) || t.push(new __PRIVATE_RemovedLimboDocument(e2));
    }), this.aa.forEach((n) => {
  ...
  // PORTING NOTE: Multi-tab only.
  Ra(e) {
    this.oa = e.Ps, this.aa = __PRIVATE_documentKeySet();
...
var __PRIVATE_SyncEngineImpl = class {
  constructor(e, t, n, r2, i, s) {
    this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r2, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.fa = {}, this.ga = new ObjectMap((e2) => __PRIVATE_canonifyQuery(e2), __PRIVATE_queryEquals), this.pa = /* @__PURE__ */ new Map(), /**
    ...
    this.Ca = /* @__PURE__ */ new Map(), this.va = __PRIVATE_TargetIdGenerator.Ln(), this.onlineState = "Unknown", // The primary state is set to `true` or `false` immediately after Firestore
...
async function __PRIVATE_syncEngineListen(e, t) {
  ...
  const s = n.ga.get(t);
  if (s)
    r2 = s.targetId, n.sharedClientState.addLocalQueryTarget(r2), i = s.view.Va();
  else {
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r2, i) {
  e.Ma = (t2, n2, r3) => async function __PRIVATE_applyDocChanges(e2, t3, n3, r4) {
    let i2 = t3.view.ha(n3);
    i2.es && // The query has a limit and some docs were removed, so we need
    ...
    (i2 = await __PRIVATE_localStoreExecuteQuery(
      ...
      /* usePreviousResults= */
      false
    ).then(({ documents: e3 }) => t3.view.ha(e3, i2)));
    ...
    return __PRIVATE_updateTrackedLimbos(e2, t3.targetId, o2.Ea), o2.snapshot;
  }(e, t2, n2, r3);
  const s = await __PRIVATE_localStoreExecuteQuery(
    ...
    /* usePreviousResults= */
    true
  ), o = new __PRIVATE_View(t, s.Ps), _ = o.ha(s.documents), a = TargetChange.createSynthesizedTargetChangeForCurrentChange(n, r2 && "Offline" !== e.onlineState, i), u = o.applyChanges(
    _,
    /* updateLimboDocuments= */
    e.isPrimaryClient,
    a
...
async function __PRIVATE_syncEngineUnlisten(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = n.ga.get(t), i = n.pa.get(r2.targetId);
  if (i.length > 1)
    return n.pa.set(r2.targetId, i.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void n.ga.delete(t);
  ...
  try {
    const e2 = await function __PRIVATE_localStoreWriteLocally(e3, t2) {
      ...
      return n2.persistence.runTransaction("Locally write mutations", "readwrite", (e4) => {
        let _ = __PRIVATE_mutableDocumentMap(), a = __PRIVATE_documentKeySet();
        return n2._s.getEntries(e4, i).next((e5) => {
    ...
    r2.sharedClientState.addPendingMutation(e2.batchId), function __PRIVATE_addMutationCallback(e3, t2, n2) {
      let r3 = e3.Da[e3.currentUser.toKey()];
      r3 || (r3 = new SortedMap(__PRIVATE_primitiveComparator));
      r3 = r3.insert(t2, n2), e3.Da[e3.currentUser.toKey()] = r3;
...
async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
  ...
  try {
    ...
    t.targetChanges.forEach((e3, t2) => {
      const r2 = n.Sa.get(t2);
      r2 && // Since this is a limbo resolution lookup, it's for a single document
      // and it could be added, modified, or removed, but not a combination.
      (__PRIVATE_hardAssert(e3.addedDocuments.size + e3.modifiedDocuments.size + e3.removedDocuments.size <= 1), e3.addedDocuments.size > 0 ? r2.ma = true : e3.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(r2.ma) : e3.removedDocuments.size > 0 && (__PRIVATE_hardAssert(r2.ma), r2.ma = false));
...
function __PRIVATE_syncEngineApplyOnlineStateChange(e, t, n) {
  ...
  if (r2.isPrimaryClient && 0 === n || !r2.isPrimaryClient && 1 === n) {
    ...
    }(r2.eventManager, t), e2.length && r2.fa.c_(e2), r2.onlineState = t, r2.isPrimaryClient && r2.sharedClientState.setOnlineState(t);
  }
}
async function __PRIVATE_syncEngineRejectListen(e, t, n) {
  const r2 = __PRIVATE_debugCast(e);
  r2.sharedClientState.updateQueryState(t, "rejected", n);
  const i = r2.Sa.get(t), s = i && i.key;
  if (s) {
    ...
    r2.wa = r2.wa.remove(s), r2.Sa.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r2);
  } else
...
async function __PRIVATE_syncEngineRegisterPendingWritesCallback(e, t) {
  ...
  try {
    ...
    const r2 = n.Ca.get(e2) || [];
    r2.push(t), n.Ca.set(e2, r2);
  } catch (e2) {
...
function __PRIVATE_triggerPendingWritesCallbacks(e, t) {
  (e.Ca.get(t) || []).forEach((e2) => {
    e2.resolve();
  }), e.Ca.delete(t);
}
function __PRIVATE_processUserCallback(e, t, n) {
  const r2 = __PRIVATE_debugCast(e);
  let i = r2.Da[r2.currentUser.toKey()];
  if (i) {
    const e2 = i.get(t);
    e2 && (n ? e2.reject(n) : e2.resolve(), i = i.remove(t)), r2.Da[r2.currentUser.toKey()] = i;
  }
}
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  e.sharedClientState.removeLocalQueryTarget(t);
  for (const r2 of e.pa.get(t))
    e.ga.delete(r2), n && e.fa.xa(r2, n);
  if (e.pa.delete(t), e.isPrimaryClient) {
    e.ba.mr(t).forEach((t2) => {
      e.ba.containsKey(t2) || // We removed the last reference for this key
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r2 of n)
    if (r2 instanceof __PRIVATE_AddedLimboDocument)
      e.ba.addReference(r2.key, t), __PRIVATE_trackLimboChange(e, r2);
    else if (r2 instanceof __PRIVATE_RemovedLimboDocument) {
      __PRIVATE_logDebug("SyncEngine", "Document no longer in limbo: " + r2.key), e.ba.removeReference(r2.key, t);
      e.ba.containsKey(r2.key) || // We removed the last reference for this key
...
function __PRIVATE_trackLimboChange(e, t) {
  ...
  e.wa.get(n) || e.ya.has(r2) || (__PRIVATE_logDebug("SyncEngine", "New document in limbo: " + n), e.ya.add(r2), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
function __PRIVATE_pumpEnqueuedLimboResolutions(e) {
  for (; e.ya.size > 0 && e.wa.size < e.maxConcurrentLimboResolutions; ) {
    const t = e.ya.values().next().value;
    e.ya.delete(t);
    const n = new DocumentKey(ResourcePath.fromString(t)), r2 = e.va.next();
    e.Sa.set(r2, new LimboResolution(n)), e.wa = e.wa.insert(n, r2), __PRIVATE_remoteStoreListen(e.remoteStore, new TargetData(__PRIVATE_queryToTarget(__PRIVATE_newQueryForPath(n.path)), r2, "TargetPurposeLimboResolution", __PRIVATE_ListenSequence.ae));
  }
}
async function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
  const r2 = __PRIVATE_debugCast(e), i = [], s = [], o = [];
  r2.ga.isEmpty() || (r2.ga.forEach((e2, _) => {
    o.push(r2.Ma(_, t, n).then((e3) => {
      if (
        ...
        i.push(e3);
        const t2 = __PRIVATE_LocalViewChanges.$i(_.targetId, e3);
        s.push(t2);
      }
    }));
  }), await Promise.all(o), r2.fa.c_(i), await async function __PRIVATE_localStoreNotifyLocalViewChanges(e2, t2) {
    ...
    for (const e3 of t2) {
      ...
      if (!e3.fromCache) {
        const e4 = n2.rs.get(t3), r3 = e4.snapshotVersion, i2 = e4.withLastLimboFreeSnapshotVersion(r3);
        n2.rs = n2.rs.insert(t3, i2);
      }
    }
  }(r2.localStore, s));
}
async function __PRIVATE_syncEngineHandleCredentialChange(e, t) {
  ...
  if (!n.currentUser.isEqual(t)) {
    ...
    n.sharedClientState.handleUserChange(t, e2.removedBatchIds, e2.addedBatchIds), await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e2.cs);
  }
}
function __PRIVATE_syncEngineGetRemoteKeysForTarget(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = n.Sa.get(t);
  if (r2 && r2.ma)
    return __PRIVATE_documentKeySet().add(r2.key);
  {
    ...
    if (!r3)
      return e2;
    for (const t2 of r3) {
      const r4 = n.ga.get(t2);
      e2 = e2.unionWith(r4.view.la);
    }
    return e2;
  }
}
async function __PRIVATE_synchronizeViewAndComputeSnapshot(e, t) {
  ...
  return n.isPrimaryClient && __PRIVATE_updateTrackedLimbos(n, t.targetId, i.Ea), i;
}
...
async function __PRIVATE_syncEngineApplyBatchState(e, t, n, r2) {
  const i = __PRIVATE_debugCast(e), s = await function __PRIVATE_localStoreLookupMutationDocuments(e2, t2) {
    ...
    return n2.persistence.runTransaction("Lookup mutation documents", "readonly", (e3) => r3.Fn(e3, t2).next((t3) => t3 ? n2.localDocuments.getDocuments(e3, t3) : PersistencePromise.resolve(null)));
  }(i.localStore, t);
  null !== s ? ("pending" === n ? (
...
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  const n = __PRIVATE_debugCast(e);
  if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.Fa) {
    ...
    n.Fa = true, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, true);
    for (const e3 of t2)
      __PRIVATE_remoteStoreListen(n.remoteStore, e3);
  } else if (false === t && false !== n.Fa) {
    const e2 = [];
    ...
    function __PRIVATE_resetLimboDocuments(e3) {
      ...
      }), t3.ba.gr(), t3.Sa = /* @__PURE__ */ new Map(), t3.wa = new SortedMap(DocumentKey.comparator);
    }(n), n.Fa = false, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
  }
}
async function __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(e, t, n) {
  ...
  for (const e2 of t) {
    let t2;
    const n2 = r2.pa.get(e2);
    if (n2 && 0 !== n2.length) {
      t2 = await __PRIVATE_localStoreAllocateTarget(r2.localStore, __PRIVATE_queryToTarget(n2[0]));
      for (const e3 of n2) {
        const t3 = r2.ga.get(e3), n3 = await __PRIVATE_synchronizeViewAndComputeSnapshot(r2, t3);
...
function __PRIVATE_syncEngineGetActiveClients(e) {
  return function __PRIVATE_localStoreGetActiveClients(e2) {
    return __PRIVATE_debugCast(__PRIVATE_debugCast(e2).persistence).ki();
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r2.Fa) {
    ...
    for (const e2 of n)
      r2.pa.has(e2) && // Release queries that are still active.
      await __PRIVATE_localStoreReleaseTarget(
        r2.localStore,
        e2,
        /* keepPersistedTargetData */
...
function __PRIVATE_ensureWatchCallbacks(e) {
  const t = __PRIVATE_debugCast(e);
  return t.remoteStore.remoteSyncer.applyRemoteEvent = __PRIVATE_syncEngineApplyRemoteEvent.bind(null, t), t.remoteStore.remoteSyncer.getRemoteKeysForTarget = __PRIVATE_syncEngineGetRemoteKeysForTarget.bind(null, t), t.remoteStore.remoteSyncer.rejectListen = __PRIVATE_syncEngineRejectListen.bind(null, t), t.fa.c_ = __PRIVATE_eventManagerOnWatchChange.bind(null, t.eventManager), t.fa.xa = __PRIVATE_eventManagerOnWatchError.bind(null, t.eventManager), t;
}
  ...
  (async function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    try {
      ...
      if (await function __PRIVATE_localStoreHasNewerBundle(e3, t3) {
        ...
        return n3.persistence.runTransaction("hasNewerBundle", "readonly", (e4) => n3.Ur.getBundleMetadata(e4, t3.id)).then((e4) => !!e4 && e4.createTime.compareTo(r4) >= 0);
      }(e2.localStore, r3))
      ...
      let s = await t2.Oa();
      for (; s; ) {
        const e3 = await i.na(s);
        e3 && n2._updateProgress(e3), s = await t2.Oa();
      }
      ...
      await function __PRIVATE_localStoreSaveBundle(e3, t3) {
        ...
        return n3.persistence.runTransaction("Save bundle", "readwrite", (e4) => n3.Ur.saveBundleMetadata(e4, t3));
      }(e2.localStore, r3), n2._completeWith(o.progress), Promise.resolve(o.ia);
    } catch (e3) {
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class extends MemoryOfflineComponentProvider {
  constructor(e, t, n) {
    super(), this.Na = e, this.cacheSizeBytes = t, this.forceOwnership = n, this.synchronizeTabs = false;
  }
  async initialize(e) {
    await super.initialize(e), await this.Na.initialize(this, e), // Enqueue writes from a previous session
    await __PRIVATE_syncEngineEnsureWriteCallbacks(this.Na.syncEngine), await __PRIVATE_fillWritePipeline(this.Na.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
    // set it after localStore / remoteStore are started.
    await this.persistence.gi(() => (this.gcScheduler && !this.gcScheduler.started && this.gcScheduler.start(), this.indexBackfillerScheduler && !this.indexBackfillerScheduler.started && this.indexBackfillerScheduler.start(), Promise.resolve()));
  }
  createLocalStore(e) {
    return __PRIVATE_newLocalStore(this.persistence, new __PRIVATE_QueryEngine(), e.initialUser, this.serializer);
  }
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  constructor(e, t) {
    super(
      ...
      /* forceOwnership= */
      false
    ), this.Na = e, this.cacheSizeBytes = t, this.synchronizeTabs = true;
  }
  async initialize(e) {
    ...
    this.sharedClientState instanceof __PRIVATE_WebStorageSharedClientState && (this.sharedClientState.syncEngine = {
      Xs: __PRIVATE_syncEngineApplyBatchState.bind(null, t),
      eo: __PRIVATE_syncEngineApplyTargetState.bind(null, t),
      no: __PRIVATE_syncEngineApplyActiveTargetsChange.bind(null, t),
      ki: __PRIVATE_syncEngineGetActiveClients.bind(null, t),
      Zs: __PRIVATE_syncEngineSynchronizeWithChangedDocuments.bind(null, t)
    }, await this.sharedClientState.start()), // NOTE: This will immediately call the listener, so we make sure to
    // set it after localStore / remoteStore are started.
    await this.persistence.gi(async (e2) => {
      await __PRIVATE_syncEngineApplyPrimaryState(this.Na.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
    });
  }
  createSharedClientState(e) {
...
var OnlineComponentProvider = class {
  ...
  createSyncEngine(e, t) {
    return function __PRIVATE_newSyncEngine(e2, t2, n, r2, i, s, o) {
      ...
      return o && (_.Fa = true), _;
    }(this.localStore, this.remoteStore, this.eventManager, this.sharedClientState, e.initialUser, e.maxConcurrentLimboResolutions, t);
  }
  terminate() {
    return async function __PRIVATE_remoteStoreShutdown(e) {
      const t = __PRIVATE_debugCast(e);
      __PRIVATE_logDebug("RemoteStore", "RemoteStore shutting down."), t.F_.add(
        5
        /* OfflineCause.Shutdown */
      ), await __PRIVATE_disableNetworkInternal(t), t.x_.shutdown(), // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
     ...
     * content.
     */
    this.buffer = new Uint8Array(), this.qa = function __PRIVATE_newTextDecoder() {
      return new TextDecoder("utf-8");
    }(), // Read the metadata (which is the first element).
    this.Qa().then((e2) => {
      e2 && e2.ea() ? this.metadata.resolve(e2.X_.metadata) : this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
             ${JSON.stringify(null == e2 ? void 0 : e2.X_)}`));
  ...
  async Qa() {
    ...
    if (null === e)
      return null;
    const t = this.qa.decode(e), n = Number(t);
    isNaN(n) && this.$a(`length string (${t}) is not valid number`);
    const r2 = await this.Ua(n);
  ...
  async Ua(e) {
    for (; this.buffer.length < e; ) {
      await this.Ga() && this.$a("Reached the end of bundle when more is expected.");
    }
...
var Transaction$2 = class {
  ...
  async lookup(e) {
    ...
    const t = await async function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
      ...
      }, s = await n.Fo("BatchGetDocuments", r2, i, t2.length), o = /* @__PURE__ */ new Map();
      s.forEach((e3) => {
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r2, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r2, this.deferred = i, this.za = n.maxAttempts, this.Ho = new __PRIVATE_ExponentialBackoff(
      this.asyncQueue,
      "transaction_retry"
  ...
  ja() {
    this.Ho.Qo(async () => {
      const e = new Transaction$2(this.datastore), t = this.Ha(e);
      t && t.then((t2) => {
  ...
  Ja(e) {
    this.za > 0 && this.Ya(e) ? (this.za -= 1, this.asyncQueue.enqueueAndForget(() => (this.ja(), Promise.resolve()))) : this.deferred.reject(e);
  }
  Ya(e) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => async function __PRIVATE_executeQueryFromCache(e2, t2, n2) {
    try {
      const r2 = await __PRIVATE_localStoreExecuteQuery(
        ...
        /* usePreviousResults= */
        true
      ), i = new __PRIVATE_View(t2, r2.Ps), s = i.ha(r2.documents), o = i.applyChanges(
        s,
        /* updateLimboDocuments= */
        false
      );
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
    __PRIVATE_debugCast(e2).K_.add(t2), // Immediately fire an initial event, indicating all existing listeners
    // are in-sync.
    t2.next();
  }(await __PRIVATE_getEventManager(e), n)), () => {
    n.La(), e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_removeSnapshotsInSyncListener(e2, t2) {
      __PRIVATE_debugCast(e2).K_.delete(t2);
    }(await __PRIVATE_getEventManager(e), n));
  };
}
...
function __PRIVATE_firestoreClientGetNamedQuery(e, t) {
  return e.asyncQueue.enqueue(async () => function __PRIVATE_localStoreGetNamedQuery(e2, t2) {
    ...
    return n.persistence.runTransaction("Get named query", "readonly", (e3) => n.Ur.getNamedQuery(e3, t2));
...
function __PRIVATE_firestoreClientSetPersistentCacheIndexAutoCreationEnabled(e, t) {
  return e.asyncQueue.enqueue(async () => function __PRIVATE_localStoreSetIndexAutoCreationEnabled(e2, t2) {
    __PRIVATE_debugCast(e2).ns.Wi = t2;
  }(await __PRIVATE_getLocalStore(e), t));
}
...
var __PRIVATE_AsyncQueueImpl = class {
  constructor() {
    ...
    this.iu = false, // List of TimerIds to fast-forward delays for.
    this.su = [], // Backoff timer used to schedule retries for retryable operations
    this.Ho = new __PRIVATE_ExponentialBackoff(
      this,
      "async_queue_retry"
    ...
    this.ou = () => {
      ...
      e2 && __PRIVATE_logDebug("AsyncQueue", "Visibility state changed to " + e2.visibilityState), this.Ho.$o();
    };
    const e = getDocument();
  ...
  enqueueAndForgetEvenWhileRestricted(e) {
    this._u(), // eslint-disable-next-line @typescript-eslint/no-floating-promises
    this.au(e);
  }
  enterRestrictedMode(e) {
    if (!this.eu) {
      this.eu = true, this.iu = e || false;
      const t = getDocument();
      t && "function" == typeof t.removeEventListener && t.removeEventListener("visibilitychange", this.ou);
    }
  }
  enqueue(e) {
    if (this._u(), this.eu)
    ...
    return this.au(() => this.eu && this.iu ? Promise.resolve() : (e().then(t.resolve, t.reject), t.promise)).then(() => t.promise);
  }
  enqueueRetryable(e) {
    this.enqueueAndForget(() => (this.Xa.push(e), this.uu()));
  }
  /**
  ...
  async uu() {
    if (0 !== this.Xa.length) {
      ...
      this.Xa.length > 0 && // If there are additional operations, we re-schedule `retryNextOp()`.
  ...
  au(e) {
    const t = this.Za.then(() => (this.ru = true, e().catch((e2) => {
      this.nu = e2, this.ru = false;
      const t2 = (
        /**
  ...
  enqueueAfterDelay(e, t, n) {
    this._u(), // Fast-forward delays for timerIds that have been overriden.
    this.su.indexOf(e) > -1 && (t = 0);
    const r2 = DelayedOperation.createAndSchedule(this, e, t, n, (e2) => this.cu(e2));
...
var __PRIVATE_ParseContextImpl = class ___PRIVATE_ParseContextImpl {
  ...
  Au(e) {
    var t;
    const n = null === (t = this.path) || void 0 === t ? void 0 : t.child(e), r2 = this.Eu({
      path: n,
      Ru: false
    });
    return r2.Vu(e), r2;
  ...
  gu(e) {
    return __PRIVATE_createError(e, this.settings.methodName, this.settings.pu || false, this.path, this.settings.yu);
  }
  ...
  Vu(e) {
    if (0 === e.length)
      throw this.gu("Document fields must not be empty");
    if (__PRIVATE_isWrite(this.Tu) && ge.test(e))
      throw this.gu('Document fields cannot begin and end with "__"');
  }
};
...
function __PRIVATE_parseSetData(e, t, n, r2, i, s = {}) {
  const o = e.wu(s.merge || s.mergeFields ? 2 : 0, t, n, i);
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.Tu)
      throw 1 === e.Tu ? e.gu(`${this._methodName}() can only appear at the top level of your update data`) : e.gu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
var __PRIVATE_ArrayUnionFieldValueImpl = class extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.Su.map((e2) => __PRIVATE_parseData(e2, t)), r2 = new __PRIVATE_ArrayUnionTransformOperation(n);
...
var __PRIVATE_ArrayRemoveFieldValueImpl = class extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.Su.map((e2) => __PRIVATE_parseData(e2, t)), r2 = new __PRIVATE_ArrayRemoveTransformOperation(n);
    return new FieldTransform(e.path, r2);
  }
  isEqual(e) {
    return this === e;
...
function __PRIVATE_parseUpdateVarargs(e, t, n, r2, i, s) {
  const o = e.wu(1, t, n), _ = [__PRIVATE_fieldPathFromArgument$1(t, r2, n)], a = [i];
  if (s.length % 2 != 0)
...
function __PRIVATE_parseQueryValue(e, t, n, r2 = false) {
  return __PRIVATE_parseData(n, e.wu(r2 ? 4 : 3, t));
}
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.Tu))
        throw t2.gu(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path)
        throw t2.gu(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  if (
    ...
    if (t.settings.Ru && 4 !== t.Tu)
      throw t.gu("Nested arrays are not supported");
    return function __PRIVATE_parseArray(e2, t2) {
      const n = [];
      let r2 = 0;
      for (const i of e2) {
        let e3 = __PRIVATE_parseData(i, t2.fu(r2));
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r2.isEqual(n))
        throw t2.gu(`Document reference is for database ${r2.projectId}/${r2.database} but should be for database ${n.projectId}/${n.database}`);
      return {
        referenceValue: __PRIVATE_toResourceName(e2.firestore._databaseId || t2.databaseId, e2._key.path)
      };
    }
    throw t2.gu(`Unsupported field value: ${__PRIVATE_valueDescription(e2)}`);
  }(e, t);
}
function __PRIVATE_parseObject(e, t) {
  ...
  return isEmpty(e) ? (
    ...
    const i = __PRIVATE_parseData(r2, t.Au(e2));
    null != i && (n[e2] = i);
  }), {
    mapValue: {
      fields: n
...
function __PRIVATE_validatePlainObject(e, t, n) {
  if (!__PRIVATE_looksLikeJsonObject(n) || !function __PRIVATE_isPlainObject(e2) {
    ...
    throw "an object" === r2 ? t.gu(e + " a custom object") : t.gu(e + " " + r2);
  }
}
...
function __PRIVATE_validateNewFieldFilter(e, t) {
  if (t.isInequality()) {
    ...
    if (null !== n2 && !n2.isEqual(r2))
      throw new FirestoreError(D2.INVALID_ARGUMENT, `Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${n2.toString()}' and '${r2.toString()}'`);
...
function __PRIVATE_validateOrderByAndInequalityMatch(e, t, n) {
  if (!n.isEqual(t))
    throw new FirestoreError(D2.INVALID_ARGUMENT, `Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${t.toString()}' and so you must also use '${t.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${n.toString()}' instead.`);
}
...
function onSnapshot(e, ...t) {
  ...
  return function __PRIVATE_firestoreClientListen(e2, t2, n2, r3) {
    ...
    return e2.asyncQueue.enqueueAndForget(async () => __PRIVATE_eventManagerListen(await __PRIVATE_getEventManager(e2), s2)), () => {
      i2.La(), e2.asyncQueue.enqueueAndForget(async () => __PRIVATE_eventManagerUnlisten(await __PRIVATE_getEventManager(e2), s2));
    };
...
var __PRIVATE_TestingHooksSpiImpl = class ___PRIVATE_TestingHooksSpiImpl {
  ...
  it(e) {
    this.Du.forEach((t) => t(e));
  }
  onExistenceFilterMismatch(e) {
    const t = Symbol(), n = this.Du;
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(w2, "4.2.0", e), // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
  registerVersion(w2, "4.2.0", "esm2017");
}();
export {
