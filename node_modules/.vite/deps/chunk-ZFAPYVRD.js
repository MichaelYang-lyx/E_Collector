...
} from "./chunk-VVXEVEG7.js";
import {
  init_useEventCallback,
  useEventCallback_default as useEventCallback_default2
} from "./chunk-G2USAV3U.js";
import {
  init_composeClasses
} from "./chunk-CFYRP6PE.js";
import {
  useTheme
} from "./chunk-B7AHQKUK.js";
import {
  HTMLElementType,
  _extends,
...
var Tabs = React60.forwardRef(function Tabs2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime40.jsx)(TabsRoot2, _extends({}, tabsRootProps, {
...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React69.useRef(false);
  const firstFocus = React69.useRef(true);
  const inputRef = React69.useRef(null);
  const listboxRef = React69.useRef(null);
  const [anchorEl, setAnchorEl] = React69.useState(null);
  const [focusedTag, setFocusedTag] = React69.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React69.useRef(defaultHighlighted);
  ...
  const resetInputValue = React69.useCallback((event, newValue) => {
  ...
  const [inputPristine, setInputPristine] = React69.useState(true);
  ...
  const syncHighlightedIndex = React69.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React69.useRef(false);
...
function ScrollbarSize(props) {
  ...
  const scrollbarHeight = React70.useRef();
...
var KeyboardArrowLeft_default = createSvgIcon((0, import_jsx_runtime48.jsx)("path", {
...
var KeyboardArrowRight_default = createSvgIcon((0, import_jsx_runtime49.jsx)("path", {
...
var _excluded28 = ["className", "slots", "slotProps", "direction", "orientation", "disabled"];
...
var TabScrollButton = React73.forwardRef(function TabScrollButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime50.jsx)(TabScrollButtonRoot, _extends({
    component: "div",
    ...
    children: direction === "left" ? (0, import_jsx_runtime50.jsx)(StartButtonIcon, _extends({}, startButtonIconProps)) : (0, import_jsx_runtime50.jsx)(EndButtonIcon, _extends({}, endButtonIconProps))
  }));
});
...
var _excluded29 = ["aria-label", "aria-labelledby", "action", "centered", "children", "className", "component", "allowScrollButtonsMobile", "indicatorColor", "onChange", "orientation", "ScrollButtonComponent", "scrollButtons", "selectionFollowsFocus", "slots", "slotProps", "TabIndicatorProps", "TabScrollButtonProps", "textColor", "value", "variant", "visibleScrollbar"];
...
var Tabs3 = React74.forwardRef(function Tabs4(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const [mounted, setMounted] = React74.useState(false);
  const [indicatorStyle, setIndicatorStyle] = React74.useState(defaultIndicatorStyle);
  const [displayStartScroll, setDisplayStartScroll] = React74.useState(false);
  const [displayEndScroll, setDisplayEndScroll] = React74.useState(false);
  const [updateScrollObserver, setUpdateScrollObserver] = React74.useState(false);
  const [scrollerStyle, setScrollerStyle] = React74.useState({
    overflow: "hidden",
    scrollbarWidth: 0
  });
  const valueToIndex = /* @__PURE__ */ new Map();
  const tabsRef = React74.useRef(null);
  const tabListRef = React74.useRef(null);
  const getTabsMeta = () => {
  ...
  const handleScrollbarSizeChange = React74.useCallback((scrollbarWidth) => {
    setScrollerStyle({
      overflow: null,
      scrollbarWidth
    });
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime51.jsx)(TabsScrollbarSize, {
      onChange: handleScrollbarSizeChange,
      className: clsx_default(classes.scrollableX, classes.hideScrollbar)
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime51.jsx)(ScrollButtonComponent, _extends({
      slots: {
    ...
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime51.jsx)(ScrollButtonComponent, _extends({
      slots: {
  ...
  const indicator = (0, import_jsx_runtime51.jsx)(TabsIndicator, _extends({}, TabIndicatorProps, {
    className: clsx_default(classes.indicator, TabIndicatorProps.className),
    ownerState,
    style: _extends({}, indicatorStyle, TabIndicatorProps.style)
  }));
  let childIndex = 0;
  const children = React74.Children.map(childrenProp, (child) => {
    ...
    childIndex += 1;
    return React74.cloneElement(child, _extends({
  ...
  return (0, import_jsx_runtime52.jsxs)(TabsRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    as: component
  }, other, {
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime52.jsxs)(TabsScroller, {
      ...
      ref: tabsRef,
      children: [(0, import_jsx_runtime51.jsx)(FlexContainer, {
        "aria-label": ariaLabel,
        "aria-labelledby": ariaLabelledBy,
...
true ? Tabs3.propTypes = {
   ...
   * @default false
   */
  allowScrollButtonsMobile: import_prop_types31.default.bool,
  /**
   ...
   * @default false
   */
  centered: import_prop_types31.default.bool,
  /**
   * The content of the component.
   */
   ...
   * @default 'primary'
   */
  indicatorColor: import_prop_types31.default.oneOfType([import_prop_types31.default.oneOf(["primary", "secondary"]), import_prop_types31.default.string]),
  /**
   ...
   */
  ScrollButtonComponent: import_prop_types31.default.elementType,
  /**
   ...
   * @default 'auto'
   */
  scrollButtons: import_prop_types31.default.oneOf(["auto", false, true]),
  /**
   * If `true` the selected tab changes on focus. Otherwise it only
   * changes on activation.
   */
  ...
  slotProps: import_prop_types31.default.shape({
    endScrollButtonIcon: import_prop_types31.default.oneOfType([import_prop_types31.default.func, import_prop_types31.default.object]),
    startScrollButtonIcon: import_prop_types31.default.oneOfType([import_prop_types31.default.func, import_prop_types31.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
  ...
  slots: import_prop_types31.default.shape({
    EndScrollButtonIcon: import_prop_types31.default.elementType,
    StartScrollButtonIcon: import_prop_types31.default.elementType
  }),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   * @default  {}
   */
  TabIndicatorProps: import_prop_types31.default.object,
  /**
   * Props applied to the [`TabScrollButton`](/material-ui/api/tab-scroll-button/) element.
   * @default {}
   */
  TabScrollButtonProps: import_prop_types31.default.object,
  /**
   * Determines the color of the `Tab`.
   * @default 'primary'
   */
  textColor: import_prop_types31.default.oneOf(["inherit", "primary", "secondary"]),
  /**
   * The value of the currently selected `Tab`.
   ...
   * @default 'standard'
   */
  variant: import_prop_types31.default.oneOf(["fullWidth", "scrollable", "standard"]),
  /**
   * If `true`, the scrollbar is visible. It can be useful when displaying
   * a long vertical list of tabs.
   * @default false
   */
  visibleScrollbar: import_prop_types31.default.bool
} : void 0;
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZFAPYVRD.js.map
