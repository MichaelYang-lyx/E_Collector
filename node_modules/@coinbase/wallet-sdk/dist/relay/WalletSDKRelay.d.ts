...
export declare class WalletSDKRelay extends WalletSDKRelayAbstract {
    ...
    private dappDefaultChainSubject;
    private dappDefaultChain;
    ...
    addEthereumChain(chainId: string, rpcUrls: string[], iconUrls: string[], blockExplorerUrls: string[], chainName?: string, nativeCurrency?: {
        ...
        cancel: (error?: ErrorType | undefined) => void;
    };
    switchEthereumChain(chainId: string, address?: string): CancelablePromise<SwitchEthereumChainResponse>;
