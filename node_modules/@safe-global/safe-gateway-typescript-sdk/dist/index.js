...
function getRecommendedNonce(chainId, address) {
    return (0, endpoint_1.getEndpoint)(baseUrl, '/v1/chains/{chainId}/safes/{safe_address}/recommended-nonce', {
        path: { chainId, safe_address: address },
    });
}
exports.getRecommendedNonce = getRecommendedNonce;
/**
